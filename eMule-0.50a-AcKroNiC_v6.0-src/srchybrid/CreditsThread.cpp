...
//>>> taz::AcK credits
	m_arCredits.Add(_T("02:04:conversion to AcKroNiC"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:taz"));
	m_arCredits.Add(_T("S:10"));
	m_arCredits.Add(_T("02:04:Graphics by"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Raid"));

	m_arCredits.Add(_T("S:10"));
	m_arCredits.Add(_T("02:04:Additional translation by (on the make)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:ITA - ITA TEAM (DarkForge.it)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:HEB - taz"));
	m_arCredits.Add(_T("S:10"));
	m_arCredits.Add(_T("02:04:Tested by"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Raid"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Mulo da Soma"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Emulizzato"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:KID"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Niphlod"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Cris 71"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:FadeToBlack"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:YOODA120"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:ScarCrow"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:SS1900"));

	m_arCredits.Add(_T("S:10"));
	m_arCredits.Add(_T("03:00:Official credits are following...")); //>>> WiZaRd
...
//<<< taz::AcK credits
	...
	m_arCredits.Add(_T("S:05"));
	m_arCredits.Add(_T("01:06:Portugese: Filipe, Lus Claro"));
	m_arCredits.Add(_T("S:05"));
