...
#include "AcK/SettingsSaver.h" //>>> taz::drop sources // drop sources - Stulle
...
private: //>>> taz::drop sources // drop sources - Stulle
...
public:
	// ==> drop sources - Stulle
	void RemoveSourceAndDontAsk(CUpDownClient* toremove, CPartFile *file, bool bDoStatsUpdate = true); //>>> taz::don't drop complete sources
