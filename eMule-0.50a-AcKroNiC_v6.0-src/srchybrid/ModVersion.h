...
//>>> taz::Version Check 0 : release, 1-100 : beta, >100 : rc (release candidate)
#define MOD_VERSION_BUILD   0
//<<< taz::Version Check
#define	MOD_VERSION			_T("AcKroNiC")
#define	MOD_VERSION_LONG	_T("AcKroNiC v")
#define DEFAULT_NICK		(MOD_VERSION + CString(L" UsEr")) //>>> taz::NewDefaultNick [WiZaRd]
#define MOD_FORUM_URL	(L"http://www.ackronic.net/ackws/smf/index.php?board=40.0")
