...
#else
		m_htiIsPayBackFirst = m_ctrlTreeOptions.InsertCheckBox(GetResString(IDS_PAYBACKFIRST), TVI_ROOT, m_bIsPayBackFirst);//EastShare - added by AndCycle, Pay Back First
