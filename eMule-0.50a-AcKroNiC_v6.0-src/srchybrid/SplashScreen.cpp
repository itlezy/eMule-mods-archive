...
//>>> taz::AcK - larger splash
/*
			CRect rc(0, (int)(BM.bmHeight * 0.65), BM.bmWidth, BM.bmHeight);
*/
			CRect rc(0, (int)(BM.bmHeight * 0.80), BM.bmWidth, BM.bmHeight);
//<<< taz::AcK - larger splash
...
*/
			...
			CString strAppVersion = theApp.m_strModLongVersion;
#else
			CString strAppVersion = theApp.m_strModVersion;
#endif
			if (theApp.m_nMVersionBld > 0)
				if (theApp.m_nMVersionBld > 100)
					strAppVersion.AppendFormat(L" %s %u", L"RC", theApp.m_nMVersionBld - 100);
				else
					strAppVersion.AppendFormat(L" %s %u", L"BETA", theApp.m_nMVersionBld);
//<<< taz::Version Check
...
//>>> taz::AcK - change copyright note
/*
			dc.DrawText(_T("Copyright (C) 2002-2009 Merkur"), &rc, DT_CENTER | DT_NOPREFIX);
*/
			dc.DrawText(_T("eMule is copyrighted (C) 2002-2010 Merkur"), &rc, DT_CENTER | DT_NOPREFIX);
//<<< taz::AcK - change copyright note
			font.DeleteObject();
		}
	}
