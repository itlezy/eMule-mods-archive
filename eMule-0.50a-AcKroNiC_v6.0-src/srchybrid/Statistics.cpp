...
// session
uint64	CStatistics::m_uUploadedPowershareComplete_Session;
uint64	CStatistics::m_uUploadedPowersharePartfile_Session;
// global
uint64	CStatistics::m_uUploadedPowershareComplete_Global;
uint64	CStatistics::m_uUploadedPowersharePartfile_Global;
//<<< taz::PowerShare stats
...
//>>> taz::PowerShare stats
	// session
	m_uUploadedPowershareComplete_Session = 0;
	m_uUploadedPowersharePartfile_Session = 0;
	// global
	m_uUploadedPowershareComplete_Global = 0;
	m_uUploadedPowersharePartfile_Global = 0;
//<<< taz::PowerShare stats
}
