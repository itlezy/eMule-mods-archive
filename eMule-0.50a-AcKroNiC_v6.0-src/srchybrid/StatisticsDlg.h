...
private:
	...
	HTREEITEM	h_upload, h_up_session, up_S[/*6*/7], h_up_total, up_T[/*2*/3]; //>>> taz::PowerShare stats [pP] // Uploads Session and Total Items and Headers
...
//>>> taz::PowerShare stats [pP]
private:
	HTREEITEM   h_Powershare_Session[2];
	HTREEITEM   h_Powershare_Global[2];
//<<< taz::Powershare stats [pP]
};
