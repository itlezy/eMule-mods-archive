...
// ----------------------------------------------------------------------
//
// emulEspaסa. Added by MoNKi [MoNKi: -UPnPNAT Support-]
...
//	m_IGDControlPoint = NULL; //>>> taz::fix
	m_ctrlPoint = 0;
	m_bInit = false;
...
*/
	if (theApp.m_UPnP_IGDControlPoint == NULL) {
		theApp.m_UPnP_IGDControlPoint = new CUPnP_IGDControlPoint();
		m_IGDControlPoint = theApp.m_UPnP_IGDControlPoint;
	}
//<<< taz::fix
