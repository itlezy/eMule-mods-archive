...
protected:
	...
	int m_iRegion; //>>> taz::regional connection wizard
...
//>>> taz::regional connection wizard
	afx_msg void OnBnClickedWizOfficialRadio();
	afx_msg void OnBnClickedWizItalyRadio();
	afx_msg void OnBnClickedWizIsraelRadio();
//<<< taz::regional connection wizard
};
