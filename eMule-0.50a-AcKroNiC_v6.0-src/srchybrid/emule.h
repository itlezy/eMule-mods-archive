...
#include "WapServer/WapServer.h" //MORPH START - Added by SiRoB / Commander, Wapserver [emulEspaa]

//#define	DEFAULT_NICK		thePrefs.GetHomepageBaseURL() //>>> taz::NewDefaultNick [WiZaRd]
...
#include "AcK/ClientAnalyzer.h" //>>> WiZaRd::ClientAnalyzer
#endif
