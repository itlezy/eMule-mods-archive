...
/*MORPH - FIX for zz code*/UINT		m_nCurSessionPayloadUp;
	...
	// Download
	//
public: //>>> taz::drop sources // drop sources - Stulle
	CPartFile*	reqfile;
protected: //>>> taz::drop sources // drop sources - Stulle
...
#endif
public: //>>> taz::don't drop complete sources
	bool	IsCompleteSource() const			{return m_bCompleteSource;}
protected: //>>> taz::don't drop complete sources
#ifdef CLIENTANALYZER	
public:
	bool	IsBadGuy() const;
