							...
							LPCSTR lpszSocketAddress /*=NULL*/, BOOL bReuseAddr /*=FALSE*/ )
{
...
#endif //NOLAYERS
	{
		...
		// lupz
    //
    // adatto la finestra tcp per supportare al massimo una 10mbit con rtt <75ms
    // (è un valore di punta ed il buffer è dinamico, ciò significa che la memoria
    // viene allocata solo in caso di necessità)
    //
    // non toccare per cortesia, altrimenti l'upload non satura con pochi slot
    //
    // 100 / 10^3 * 2 * 10^7 / 8 ~= 244 * 2^10 --> 256 * 2^10
