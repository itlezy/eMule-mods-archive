...
CCatDialog::CCatDialog(int index) : CDialog(CCatDialog::IDD)
{
...
void CCatDialog::UpdateData()
{
	...
	SetDlgItemText(IDC_CATURL,m_myCat->catURL); //Mod Adu - Ded - URL per categorie
...
void CCatDialog::OnBnClickedOk()
{
	...
	GetDlgItemText(IDC_CATURL,m_myCat->catURL); //Mod Adu - Ded - URL per categorie
