...
CCreditsThread::CCreditsThread(CWnd* pWnd, HDC hDC, CRect rectScreen) : CGDIThread(pWnd,hDC)
{
...
void CCreditsThread::InitText()
{
	...
	*/
	...
	//Anis -> info compilazione
	CString data = (CString)COMPILE_DATE;
	CString ora = (CString)COMPILE_TIME;
	CString info;
	info.Format(_T("Build compilata il %s alle ore %s"),data,ora);
	m_arCredits.Add(_T("01:06:") + info);
	...
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("02:04:eMule AdunanzA Developers"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Hammon - General Manager"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Anis Hireche - Main (v.3.18) Programmer"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:anishireche@gmail.com"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:tigerjact - Main (v.3.16) Programmer"));
	m_arCredits.Add(_T("S:50"));
	m_arCredits.Add(_T("02:04:AdunanzA Installer Script NSIS"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Anis Hireche (v.3.18)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Dario Emerson 'dedo1911' (v.3.18)"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:tigerjact (v.3.16)"));
	m_arCredits.Add(_T("S:50"));
	m_arCredits.Add(_T("02:04:2D Artist"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:RENSIE"));
	m_arCredits.Add(_T("S:50"));

	m_arCredits.Add(_T("01:06:Copyright (C) 2002-2009 Merkur"));
	m_arCredits.Add(_T("S:50"));
	m_arCredits.Add(_T("02:04:Original eMule Developers"));
	m_arCredits.Add(_T("S:5"));
	...
	m_arCredits.Add(_T("02:04:Original eMule Testers"));
	m_arCredits.Add(_T("S:5"));
	...
	m_arCredits.Add(_T("02:04:Original eMule Retired Members"));
	m_arCredits.Add(_T("S:5"));
