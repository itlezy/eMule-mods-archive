...
public:
	...
	void	StoppaRiprendi(bool s_r);
	void	StopStreaming(CPartFile* file); //Anis Hireche's function
	void	ControllaStreaming();
protected:
	...
	CMenu		m_SourcesMenu;
	CTitleMenu	m_A4AFMenu; // NEO: MCM - [ManualClientManagement]
	bool		m_bRemainSort;
    ...
    static int Compare(const CUpDownClient* client1, const CUpDownClient* client2, LPARAM lParamSort, int sortMod = 1);
