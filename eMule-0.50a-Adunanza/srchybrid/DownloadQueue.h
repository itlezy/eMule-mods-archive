...
public:
	...
	void RemoveSourceAndDontAsk(CUpDownClient* client, bool bUpdateStats = true, uint8 uDropType = 0);
	...
	bool	AddDownload(CPartFile* newfile, bool paused); //Anis -> valore di ritorno per sapere se il file è già in download
...
private:
	...
	uint64		m_datarateMS;
	uint64		m_datarateMSext;
	uint64		m_datarateMSkadu;
	...
	//tigerjact
	CList<TransferredData> avarage_dr_listKADU;
	CList<TransferredData> avarage_dr_listEXT;
