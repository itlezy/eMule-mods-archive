...
*/
	// opcode remoto
	if (pbyBufIn[0] == OP_EMULEPROT || pbyBufIn[0] == OP_PACKEDPROT
	      || pbyBufIn[0] == OP_UDPRESERVEDPROT1 || pbyBufIn[0] == OP_UDPRESERVEDPROT2
	      || pbyBufIn[0] == theApp.rm->kadOpcode || pbyBufIn[0] == theApp.rm->kadZOpcode)
		return nResult;
