...
wchar_t * __cdecl ID3_GetStringW(const ID3_Frame *frame, ID3_FieldID fldName)
{
...
wchar_t * __cdecl ID3_GetStringW(const ID3_Frame *frame, ID3_FieldID fldName, size_t nIndex)
{
