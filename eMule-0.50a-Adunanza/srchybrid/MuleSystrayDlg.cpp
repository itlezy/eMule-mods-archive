...
BEGIN_MESSAGE_MAP(CMuleSystrayDlg, CDialog)
	...
	//}}AFX_MSG_MAP
	ON_STN_CLICKED(IDC_TRAYDOWN, OnStnClickedTraydown)
	ON_STN_CLICKED(IDC_TRAYUP, OnStnClickedTrayup)
END_MESSAGE_MAP()
...
void CMuleSystrayDlg::OnStnClickedTraydown()
{
	// TODO: aggiungere qui il codice per la gestione della notifica del controllo.
}

void CMuleSystrayDlg::OnStnClickedTrayup()
{
	// TODO: aggiungere qui il codice per la gestione della notifica del controllo.
}
