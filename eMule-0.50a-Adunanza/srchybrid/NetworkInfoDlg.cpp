...
#include "AdunanzA.h" //Anis -> + info nel dialog -> tipo connessione
...
void CreateNetworkInfo(CRichEditCtrlX& rCtrl, CHARFORMAT& rcfDef, CHARFORMAT& rcfBold, bool bFullInfo)
{
	...
	if (theApp.serverconnect->IsConnected()){
		...
		{
			if(AduIsFastWebIP(ntohl(Kademlia::CKademlia::GetPrefs()->GetIPAddress())))
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
	// TIPO TECNOLOGIA CONNESSIONE - ANIS																//
	/////////////////////////////////////////////////////////////////////////////////////////////////////
	rCtrl << _T("\r\n");
	rCtrl.SetSelectionCharFormat(rcfBold);

	if (thePrefs.adsl_fiber == ADSL)
		rCtrl  << _T("TIPO RETE: ADSL") << _T("\r\n");

	else if (thePrefs.adsl_fiber == FIBRA)
		rCtrl  << _T("TIPO RETE: FIBRA OTTICA") << _T("\r\n");
}
