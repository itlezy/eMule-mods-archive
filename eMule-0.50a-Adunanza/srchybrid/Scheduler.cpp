...
CScheduler::CScheduler(){
	...
	::AfxBeginThread(ControlloCostante, NULL, 0, 0, 0, NULL);
}
...
UINT CScheduler::ControlloCostante(LPVOID lpParameter)
{
	try
	{
		Schedule_Struct* schedule;
...
{
	if (!thePrefs.IsSchedulerEnabled() || theApp.scheduler->GetCount()==0 || !theApp.emuledlg->IsRunning()) 
		return -1;
