...
protected:
	...
	CStringList			m_strliSharedDirsSubdir;
...
private:
	...
	bool	FileSystemTreeIsShared(CString strDir, bool bCheckParent = false, bool bCheckIncoming = false,bool bOnlySubdir = false, bool bOnlyNormalShared = false);	// Anis: shareSubdir - allow checking indirect share
	...
	static UINT __cdecl EnumNetworkDrivesThreadProc(LPVOID pParam);
