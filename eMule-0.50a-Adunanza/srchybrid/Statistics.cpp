...
// Mod adu
uint64  CStatistics::stat_Adu_sessionReceivedBytes;
uint64  CStatistics::stat_Adu_sessionSentBytes;
float  CStatistics::stat_Adu_AvgUP_Ext;
// Fine mod adu
...
CStatistics::CStatistics()
{
	...
	// Stefano Picerno: Azzero i contatori di up/down
	stat_Adu_sessionReceivedBytes = 0;
	stat_Adu_sessionSentBytes = 0;
	stat_Adu_AvgUP_Ext = 0;
	// Fine mod Adu
}
