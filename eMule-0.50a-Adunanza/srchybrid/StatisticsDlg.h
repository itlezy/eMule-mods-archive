...
private:
	...
	// mod Adu
	// Emanem
	// Handle treeview AdunanzA
	HTREEITEM h_Adu_main;
	HTREEITEM h_Adu_cur_downloaded;
	HTREEITEM h_Adu_cur_uploaded;
	HTREEITEM h_Adu_dlExt_dlAdu;
	HTREEITEM h_Adu_upExt_upAdu;
	HTREEITEM h_Adu_upExt_media;
	HTREEITEM h_Adu_Adu_updl;
	HTREEITEM h_Adu_Ext_updl;
	// fine mod Adu
