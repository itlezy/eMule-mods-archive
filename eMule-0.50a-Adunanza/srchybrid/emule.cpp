...
//Anis -> gestione automatica refresh file condivisi
...
{
	// Anis -> Inizializzazione moduli sicurezza gestione memoria
	InitSafeSEH();
	InitDEP();
...
//Anis -> Aggiunta compatibilità vs2010

#if _MFC_VER==0x0700 || _MFC_VER==0x0710 || _MFC_VER==0x0800 || _MFC_VER==0x0900 || _MFC_VER==0x0A00 || _MFC_VER==0x0B00
...
#error "You are using an MFC version which may require a special version of the above function!"
	...
	//Anis -> Check splashscreen version
	...
	//>>> Anis::Better Handling of Removeable Drives
	...
	{  //leuk_he add startupAnis auto detect
...
//							theApp.emuledlg->sharedfileswnd->Reload();
							theApp.emuledlg->sharedfileswnd->SendMessage(WM_COMMAND, IDC_RELOADSHAREDFILES); //>>> Anis::FiX! - Don't access the main thread from within a thread
