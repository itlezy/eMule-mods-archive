...
namespace Kademlia
{
	...
	class CIndexed
	{
		public:
			...
			CIndexed();
			~CIndexed();
			bool AddKeyword(const CUInt128& uKeyWordID, const CUInt128& uSourceID, Kademlia::CKeyEntry* pEntry, uint8& uLoad, bool bIgnoreThreadLock = false, bool loading = false);
