...
#define KADEMLIAREASKTIME		MIN2MS(45)	//1 hour
#define KADEMLIAPUBLISHTIME		SEC(2)		//2 second
#define KADEMLIATOTALSTORENOTES	1			//Total hashes to store.
#define KADEMLIATOTALSTORESRC	3*6			//Total hashes to store.
#define KADEMLIATOTALSTOREKEY	2*8			//Total hashes to store.
...
#define TAG_KADREPUBLISHTIMEK	"\x39" // <uint32>
...
#define FT_SOTN					"SOTN" //>>> Anis::Intelligent SOTN
#define FT_POWERSHARE			"ADU_POWERSHARE" //>>> Anis::PowerShare

//>>> Anis::ICS [enkeyDEV]
#define ET_INCOMPLETEPARTS		0x3D
#define OP_FILEINCSTATUS		0x8E //Incomplete part packet (like OP_FILESTATUS)
//### Anis::ICS [enkeyDEV]
#define MAXPRIORITYCOLL_SIZE	(thePrefs.GetSmallFileSize()*1024)		// massima dimensione della parte accettata per saltare la coda