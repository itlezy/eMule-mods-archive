...
void CEditDelayed::OnInit(CListCtrl* parentlist){
	...
	CHeaderCtrl* m_pctrlColumnHeader = parentlist->GetHeaderCtrl();
	//Xman end
	...
	if (m_pctrlColumnHeader != NULL) //Xman proper EditDelayed
...
void CEditDelayed::OnLButtonDown(UINT nFlags, CPoint point){
	CHeaderCtrl* m_pctrlColumnHeader = m_parentlist->GetHeaderCtrl(); //Xman proper EditDelayed
