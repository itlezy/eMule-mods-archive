...
protected:
	...
	bool m_bTK4namecheckdisabled;//TK4 Mod - [FDC] allow user to dissable name disparity check.
	bool m_bLog2Disk;
	bool m_bDebug2Disk;
	bool m_bIntelliFlush; // Spike2 from WiZaRd - IntelliFlush
	int m_iCommitFiles;
	...
	*/
	...
	HTREEITEM m_htiIntelliFlush; // Spike2 from WiZaRd - IntelliFlush
	...
	*/
	...
	HTREEITEM m_htiTK4namecheckdisabled; //TK4 - [FDC] 
