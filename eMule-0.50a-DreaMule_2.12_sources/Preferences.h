...
static int const PriorityClasses[] = { REALTIME_PRIORITY_CLASS, HIGH_PRIORITY_CLASS, ABOVE_NORMAL_PRIORITY_CLASS, NORMAL_PRIORITY_CLASS, BELOW_NORMAL_PRIORITY_CLASS, IDLE_PRIORITY_CLASS };
// [TPT] - Select process priority
...
//>>> WiZaRd::IntelliFlush
private:
	static	bool	m_bIntelliFlush;
public:
	static	bool	IsUseIntelliFlush() 				{return m_bIntelliFlush;}
//<<< WiZaRd::IntelliFlush
};
