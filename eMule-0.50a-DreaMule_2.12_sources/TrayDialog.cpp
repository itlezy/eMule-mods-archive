...
void CTrayDialog::TraySetIcon(UINT nResourceID, bool bDelete /* Avi3k: fix arg */)
{
	TraySetIcon(AfxGetApp()->LoadIcon(nResourceID), bDelete /* Avi3k: fix arg */);
}

void CTrayDialog::TraySetIcon(LPCTSTR lpszResourceName, bool bDelete /* Avi3k: fix arg */)
{
