...
enum EClientSoftware{
	...
	SO_SHAREAZA3		= 40,   // Spike2 - Enhanced Client Recognization
	// other client types which are not identified with ET_COMPATIBLECLIENT
	SO_EDONKEYHYBRID	= 50,
	SO_EDONKEY			= 51,	// Spike2 - Enhanced Client Recognization (from aMule)
	SO_MLDONKEY2		= 52,	// Spike2 - Enhanced Client Recognization (from aMule)
	SO_OLDEMULE			= 53,	// Spike2 - Enhanced Client Recognization (from aMule)
	SO_SHAREAZA4		= 68,	// Spike2 - Enhanced Client Recognization (from aMule)
	SO_MLDONKEY3		= 152,	// Spike2 - Enhanced Client Recognization (from aMule)
        SO_OLD_MLDONKEY, // Spike2 - Enhanced Client Recognization - Enhancement from WiZaRd - these are the MLdonkeys with M and L in the hash :)
	SO_URL,
	SO_UNKNOWN
};
