...
{	
	return TRUE; // doesn't erase the button background
}
/////////////////////////////////////////////////////////////////////////////
...
void CxSkinButton::Set_TextPos(RECT &rect)
{
	m_TextRect.left = rect.left;
	m_TextRect.top = rect.top;
	m_TextRect.right = rect.right;
	m_TextRect.bottom = rect.bottom;
}
