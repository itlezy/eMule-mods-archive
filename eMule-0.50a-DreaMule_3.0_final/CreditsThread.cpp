...
void CCreditsThread::InitText()
{
	...
	*/
	...
	m_arCredits.Add(_T("02:04:Fórum + Tutoriais/FAQs + Coordenação da Tradução"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Juan Lourenço"));
	m_arCredits.Add(_T("S:5"));
	...
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("02:06:Inglês"));
	m_arCredits.Add(_T("S:5"));
	...
	m_arCredits.Add(_T("02:06:Francês"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Maria Marta"));
	m_arCredits.Add(_T("01:06:Claudia Samp"));
	m_arCredits.Add(_T("01:06:Adão Pontes"));
	...
	m_arCredits.Add(_T("01:06:Geazi Paixão"));
	m_arCredits.Add(_T("01:06:Inayan Bianco"));
	m_arCredits.Add(_T("01:06:Eduardo Iba Romão"));
	m_arCredits.Add(_T("S:5"));

	m_arCredits.Add(_T("02:06:Português-PT"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Antônio Mestre"));
	m_arCredits.Add(_T("01:06:Bruno Killer"));
	m_arCredits.Add(_T("01:06:MariaMarta"));
	m_arCredits.Add(_T("01:06:Gleidson Barroso Gurgel"));
	m_arCredits.Add(_T("S:5"));

	m_arCredits.Add(_T("02:06:Alemão"));
	m_arCredits.Add(_T("S:5"));
	...
	m_arCredits.Add(_T("02:06:Árabe"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Geazi, Paixão"));
	m_arCredits.Add(_T("S:5"));

		m_arCredits.Add(_T("02:06:Chinês Simplificado"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Geazi, Paixão"));
	m_arCredits.Add(_T("S:5"));

	m_arCredits.Add(_T("02:06:Polonês"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:06:Geazi, Paixão"));
	m_arCredits.Add(_T("S:5"));
	...
	m_arCredits.Add(_T("02:06:Japonês"));
	m_arCredits.Add(_T("S:5"));
