...
#include "PartFile.h"
#include "kademlia/kademlia/Defines.h"	// Tux: Improvement: Kademlia interface improvement
...
void CKadSearchListCtrl::UpdateSearch(int iItem, const Kademlia::CSearch* search)
{
	...
	uint32 uBaseTime = 0;	// Tux: Improvement: Kademlia interface improvement
	switch(search->GetSearchTypes()){
		case Kademlia::CSearch::FILE:
			...
			uBaseTime = SEARCHFILE_LIFETIME - SEC(20);	// Tux: Improvement: Kademlia interface improvement
			break;
		case Kademlia::CSearch::KEYWORD:
			id = GetResString(IDS_KAD_SEARCHKW);
			SetItem(iItem,0,LVIF_IMAGE,0,1,0,0,0,0);
			uBaseTime = SEARCHKEYWORD_LIFETIME - SEC(20);	// Tux: Improvement: Kademlia interface improvement
			break;
		...
		case Kademlia::CSearch::STOREFILE:
			...
			uBaseTime = SEARCHSTOREFILE_LIFETIME - SEC(20);	// Tux: Improvement: Kademlia interface improvement
			break;
		case Kademlia::CSearch::STOREKEYWORD:
			id = GetResString(IDS_KAD_STOREKW);
			SetItem(iItem,0,LVIF_IMAGE,0,4,0,0,0,0);
			uBaseTime = SEARCHSTOREKEYWORD_LIFETIME - SEC(20);	// Tux: Improvement: Kademlia interface improvement
			break;
		//JOHNTODO: -
