...
//>>> WiZaRd::Search Redesign
	const bool bSearchList = _tcsicmp(m_Name, L"SearchListCtrl") == 0;
	if(bSearchList)
		m_iCurrentSortItem= ini.GetInt( m_Name + _T("TableSortItem"), 2);
	else
//<<< WiZaRd::Search Redesign
...
void CMuleListCtrl::SetColors(/*LPCTSTR pszLvKey*/){ // X-Ray :: Toolbar :: Cleanup
