...
{
	//m_iFileBufferSize = 0; //>>> WiZaRd::IntelliFlush
	m_iQueueSize = 0;
	m_iMaxConnPerFive = 0;
	m_iMaxHalfOpen = 0;
...
void CPPgTweaks::DoDataExchange(CDataExchange* pDX)
{
	...
	//DDX_Control(pDX, IDC_FILEBUFFERSIZE, m_ctlFileBuffSize); //>>> WiZaRd::IntelliFlush
...
BOOL CPPgTweaks::OnApply()
{
	...
	//thePrefs.m_iFileBufferSize = m_iFileBufferSize; //>>> WiZaRd::IntelliFlush
