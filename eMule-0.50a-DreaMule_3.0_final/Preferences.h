...
//boizaum merge start
	static	bool    hotkey_enabled;	    // TK4 mod
	static	int     hotkey_mod;		    // TK4 mod
	static	int     hotkey_key;		    // TK4 mod
	static  HWND    HideWnd;			// TK4 mod
	static	bool	BadNameCheck; 	    // TK4 mod - [FDC]
	static  bool    doubleFDC;          // TK4 mod - [FDC]  double detection if 'true' alert on 2 bad names
	static  int     FDCSensitivity;     // TK4 mod - [FDC]  System sensitivity
	...
	friend class CShareWiZaRdDlg; //>>> WiZaRd::ShareWiZaRd
	...
	static bool		IsNatTraversalEnabled()		{return true;} 
	static UINT		UseLowIDUploadCallBack()	{return 2;} // NEO: LUC - [LowIDUploadCallBack]
	static bool		ReuseTCPPort()				{return false;} // NEO: RTP - [ReuseTCPPort] // Warning: yet not vista ready !!!
	...
	//DreaMule bugfix
	static	bool GetUPnPNatTryRandom()  { return false; }
	//DreaMule
...
private:
	static	bool		m_bMinimizeOnClose; 
public:
	static	bool		GetMinimizeOnClose()			{return m_bMinimizeOnClose;}
	static	void		SetMinimizeOnClose(const bool b){m_bMinimizeOnClose = b;}
//<<< WiZaRd::Minimize on Close
...
//>>> WiZaRd::MediaPlayer
public:
	static	bool	VLC_IsMuted()							{return m_bVLCMuted;}
	static	void	VLC_SetMuted(const bool b)				{m_bVLCMuted = b;}
	static	int		VLC_GetVolume()							{return m_iVLCVolume;}
	static	void	VLC_SetVolume(const int i)				{m_iVLCVolume = i;}
private:
	static	bool	m_bVLCMuted;
	static	int		m_iVLCVolume;
//<<< WiZaRd::MediaPlayer
//>>> WiZaRd::ShutDownIfFinished
public:
	static	bool	IsShutDownIfFinished()					{return m_bShutDownIfFinished;}
	static	void	SetShutDownIfFinished(const bool b)		{m_bShutDownIfFinished = b;}
private:
	static	bool	m_bShutDownIfFinished;
//<<< WiZaRd::ShutDownIfFinished
//>>> WiZaRd::StatusSmilies
public:
	static	bool	IsDisplayStatusSmilies()					{return m_bDisplayStatusSmilies;}
	static	void	SetDisplayStatusSmilies(const bool b)		{m_bDisplayStatusSmilies = b;}
private:
	static	bool	m_bDisplayStatusSmilies;
//<<< WiZaRd::StatusSmilies
};
