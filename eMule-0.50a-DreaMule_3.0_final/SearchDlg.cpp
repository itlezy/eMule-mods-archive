...
//>>> WiZaRd::Search Redesign
						 //WS_CHILD | WS_VISIBLE | CBRS_LEFT | CBRS_SIZE_FIXED | CBRS_SIZE_DYNAMIC | CBRS_GRIPPER, 
...
//>>> WiZaRd::Search Redesign
	...
	//DockControlBar(m_pwndParams, AFX_IDW_DOCKBAR_LEFT, (LPRECT)NULL);
//<<< WiZaRd::Search Redesign
...
//		UINT uMRUDockID = AFX_IDW_DOCKBAR_LEFT;
//<<< WiZaRd::Search Redesign
