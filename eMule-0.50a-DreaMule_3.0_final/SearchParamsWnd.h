...
#include "IconStatic.h" //>>> WiZaRd::Search Redesign
...
//	CButton m_ctlUnicode; 
	bool	m_bMoreMode;
	void	ToggleStartMore(const sint8 iStart);
//<<< WiZaRd::Search Redesign
...
protected:
	...
	CRect m_rcOpts;
	CRect m_rcStart;
//	CRect m_rcMore; //>>> WiZaRd::Search Redesign
	CRect m_rcCancel;
//>>> WiZaRd::Search Redesign
//	CRect m_rcUnicode; 
	uint8	m_uiUnicode; 
	CIconStatic m_ctrlSearchControlsFrm;
	CIconStatic m_ctrlSearchParamsFrm;
//<<< WiZaRd::Search Redesign
