...
#include "opcodes.h"
#include "InputBox.h" //>>> WiZaRd::ShareWiZaRd
...
BOOL CConnectionWizardDlg::OnInitDialog()
{
	...
	*/
	...
	m_provider.InsertItem(1,_T("Velox /Speedy 256k"));m_provider.SetItemText(1,1,_T("256"));m_provider.SetItemText(1,2,_T("128")); //Xman dummy
	//Xman end
	m_provider.InsertItem(2,_T("Velox /Speedy 512k"));m_provider.SetItemText(2,1,_T("512"));m_provider.SetItemText(2,2,_T("128"));
	m_provider.InsertItem(3,_T("Velox /Speedy 1 Mega"));m_provider.SetItemText(3,1,_T("1024"));m_provider.SetItemText(3,2,_T("400"));
	m_provider.InsertItem(4,_T("Velox /Speedy 2 Megas"));m_provider.SetItemText(4,1,_T("2048"));m_provider.SetItemText(4,2,_T("600"));

	m_provider.InsertItem(5,_T("Cabo 1 mega"));m_provider.SetItemText(5,1,_T("1024"));m_provider.SetItemText(5,2,_T("384"));
	m_provider.InsertItem(6,_T("Cabo 1,5 megas"));m_provider.SetItemText(6,1,_T("1536"));m_provider.SetItemText(6,2,_T("512"));
	m_provider.InsertItem(7,_T("Cabo 2 megas"));m_provider.SetItemText(7,1,_T("2048"));m_provider.SetItemText(7,2,_T("768"));
	m_provider.InsertItem(8,_T("Cabo 4 megas"));m_provider.SetItemText(8,1,_T("4096"));m_provider.SetItemText(8,2,_T("868"));
...
void CConnectionWizardDlg::OnNMClickProviders(NMHDR* /*pNMHDR*/, LRESULT* pResult)
{
	...
	case  3: down= 1024;	up=  400; break;
	case  4: down= 2048;	up=  600; break;
	case  5: down= 1024;	up=  384; break;
	case  6: down= 1536;	up=  512; break;
	case  7: down= 2048;	up=  768; break;
	case  8: down= 4096;	up=  868; break;
