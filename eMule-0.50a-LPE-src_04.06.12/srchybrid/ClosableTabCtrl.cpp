...
void CClosableTabCtrl::SetAllIcons()
{
	if (m_bCloseable)
	{
		...
		m_ImgLstCloseButton.Add(CTempIconLoader(_T("FILTERCLEAR1"), iIconWidth, iIconHeight));
		m_ImgLstCloseButton.Add(CTempIconLoader(_T("FILTERCLEAR2"), iIconWidth, iIconHeight));
