...
// Timestamp.h
//
// $Id: //poco/1.3/Foundation/include/Poco/Timestamp.h#3 $
//
// Library: Foundation
// Package: DateTime
// Module:  Timestamp
...
{
public:
	typedef sint64 TimeVal;    /// monotonic UTC time value in microsecond resolution
	typedef sint64 UtcTimeVal; /// monotonic UTC time value in 100 nanosecond resolution
	typedef sint64 TimeDiff;   /// difference between two timestamps in microseconds
