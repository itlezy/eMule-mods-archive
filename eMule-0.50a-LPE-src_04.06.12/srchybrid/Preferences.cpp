...
bool	CPreferences::m_bShowSystemIcon; 
...
bool	CPreferences::m_bNativeDesktopIntegration; // netfinity: Better support for WINE Gnome/KDE desktops
//Upload Permission +
int	    CPreferences::m_iPermission;
int 	CPreferences::m_iMaxQR; 
int 	CPreferences::m_iSLI;    
bool	CPreferences::m_bOnlyEmule; 
//Upload Permission -
//morph4u - ////////////////////////////////////////
...
//morph4u + /////////////////////////////////////////////////
	...
	ini.WriteBool(L"ShowSystemIcon", m_bShowSystemIcon); 
...
// ==> Pay Back First
	...
	ini.WriteBool(L"WINE_NativeDesktopIntegration", m_bNativeDesktopIntegration); // netfinity: Better support for WINE Gnome/KDE desktops
	//Upload Permission +
	ini.WriteInt(L"UploadPermission", m_iPermission);
	if (m_iMaxQR<1000)
		m_iMaxQR=1000;
	if (m_iMaxQR>10000)
		m_iMaxQR=10000;
	ini.WriteInt(L"MaxQR", m_iMaxQR);
    if (m_iSLI<5)
		m_iSLI=5;
	if (m_iSLI>100)
		m_iSLI=100;
	ini.WriteInt(L"StrictLimit", m_iSLI);
	ini.WriteBool(L"OnlyEmule", m_bOnlyEmule); 
	//Upload Permission -
//morph4u - //////////////////////////////////////////////
}
...
//morph4u + ////////////////////////////////////////////////
	...
	m_bShowSystemIcon = ini.GetBool(L"ShowSystemIcon", false); 
...
// <== Pay Back First
	...
	m_bNativeDesktopIntegration = ini.GetBool(L"WINE_NativeDesktopIntegration", true); // netfinity: Better support for WINE Gnome/KDE desktops
	//Upload Permission +
	m_iPermission = ini.GetInt(L"UploadPermission", 0); 
	 m_iMaxQR=(uint16)ini.GetInt(L"MaxQR",5001);
	 if (m_iMaxQR<1000)
		 m_iMaxQR=1000;
	 if (m_iMaxQR>10000)
		 m_iMaxQR=10000;
     m_iSLI=(uint16)ini.GetInt(L"StrictLimit",50);
	 if (m_iSLI<5)
		 m_iSLI=5;
	 if (m_iSLI>100)
		 m_iSLI=100;
	 m_bOnlyEmule = ini.GetBool(L"OnlyEmule", true); 
	//Upload Permission -
//morph4u - ////////////////////////////////////////////////
}
/*
