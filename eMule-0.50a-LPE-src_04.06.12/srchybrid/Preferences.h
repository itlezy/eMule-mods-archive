...
// netfinity: Better support for WINE Gnome/KDE desktops +
	friend class CDesktopIntegration; 
	static bool   m_bNativeDesktopIntegration;
// netfinity: Better support for WINE Gnome/KDE desktops -
...
//morph4u :: PercentBar :: End
	static	bool	m_bShowSystemIcon;
	static	bool	IsSystemIcon()					{return m_bShowSystemIcon;}
// ==> Pay Back First
...
//Upload Permission +
private:
	static int	    m_iPermission;
	static	int	    m_iMaxQR;  
	static	int  	m_iSLI;                          
	static	bool	m_bOnlyEmule;
public:
	static	int	    GetPermission()	{return m_iPermission;}
	static	void    SetPermission(const int& in)			{m_iPermission = in;}
	static	int  	GetMaxQR()  { return m_iMaxQR; }
	static	void	SetMaxQR(uint16 QRin) { m_iMaxQR = QRin; }
	static	int 	GetStrictLimit()  { return m_iSLI; }
	static	void	SetStrictLimit(uint16 SLIin) { m_iSLI = SLIin; }
	static	bool	IsOnlyEmule()					{return m_bOnlyEmule;}
//Upload Permission -
//morph4u - /////////////////////////////////////////////////////
