...
#define	SEARCH_LIST_MENU_BUTTON_XOFF	2 //morph4u 8->2
...
void CSearchResultsWnd::SetAllIcons()
{
	...
	iml.Add(CTempIconLoader(_T("KADSERVER")));
...
bool CSearchResultsWnd::DoNewEd2kSearch(SSearchParams* pParams)
{
	...
	Packet* packet = new Packet(&data, OP_EDONKEYPROT, OP_SEARCHREQUEST);
#if defined(_DEBUG) || defined(USE_DEBUG_DEVICE)// X: [RDL] - [Remove Debug Log]
...
void CSearchResultsWnd::OnSearchListMenuBtnDropDown(NMHDR* /*pNMHDR*/, LRESULT* /*pResult*/)
{
	...
	menuFileSizeFormat.AppendMenu(MF_STRING, MP_SHOW_FILESIZE_KBYTE, _T("KB"));
	menuFileSizeFormat.AppendMenu(MF_STRING, MP_SHOW_FILESIZE_MBYTE, _T("MB"));
