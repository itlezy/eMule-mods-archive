...
public:
	...
	void	UpdateFile(const CShareableFile* file/*, bool force=false*/); //Xman advanced upload-priority
	void	Localize();
...
protected:
	CMenu		m_SharedFilesMenu;
	CMenu		m_CollectionsMenu;
	CMenu		m_PrioMenu;
	CMenu	    m_PermMenu;//Upload Permission
	...
	void ShowFileDialog(CAtlList<CShareableFile*>& aFiles, UINT uPshInvokePage = 0);
	void SetAllIcons();
