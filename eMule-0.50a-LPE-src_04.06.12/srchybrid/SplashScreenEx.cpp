...
#define RCWIDTH	200
#define MINWIDTH	217
//#define TEXTWIDTH	(sizeof(_T("eMule v") + theApp.m_strCurVersionLong + _T(" -LPE-"))/sizeof(TCHAR)-1)*200 //morph4u todo
#define TEXTWIDTH (sizeof(_T("eMule v0.50a -LPE-"))/sizeof(TCHAR)-1)*12
...
void CSplashScreenEx::DrawWindow()
{
	...
	g.DrawString(_T("eMule v") + theApp.m_strCurVersionLong + _T(" -LPE-"), -1, &m_myFont, m_rcText, &format, &m_myBrush);
