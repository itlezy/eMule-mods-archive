...
public:
	...
	void	UpdateConnectionStats(); // Xman
...
public:
    ...
    static uint64	sessionSentBytesToPBF;// ==> Pay Back First
...
private:
	...
	CAtlList<TransferredData,TransferredData>	m_AvarageDDRO_list;
	CAtlList<TransferredData,TransferredData>	m_AvarageUDRO_list;*/	
};
