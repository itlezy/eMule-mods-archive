...
class CUDPSocket : public CAsyncSocketEx, public CEncryptedDatagramSocket, public ThrottledControlSocket // ZZ:UploadBandWithThrottler (UDP)// X: [SUDPS] - [CAsyncSocketEx UDP Support]
{
...
public:
	...
	uint16 GetPort() const{return nPort;}
...
private:
	...
	CAtlList<SServerDNSRequest*> m_aDNSReqs;
	...
	bool m_bWouldBlock;
	CAtlList<SServerUDPPacket*> controlpacket_queue;
