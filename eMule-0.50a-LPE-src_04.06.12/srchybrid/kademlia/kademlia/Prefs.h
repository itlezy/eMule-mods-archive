...
namespace Kademlia
{
	class CPrefs
	{
		public:
			...
			uint64		GetLastContact() const;// X: [64T] - [64BitTime]
			...
			uint_ptr	GetKademliaUsers() const;
			void		SetKademliaUsers(uint_ptr uVal);
			uint_ptr	GetKademliaFiles() const;
		...
		private:
			...
			uint_ptr m_uKademliaUsers;
			uint_ptr m_uKademliaFiles;
			uint8 m_uTotalFile;
			...
			CAtlArray<uint32> m_anExternPortIPs;
			CAtlArray<uint16> m_anExternPorts;
