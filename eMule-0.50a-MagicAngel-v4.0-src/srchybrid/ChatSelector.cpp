...
{
	//sender->IncMessagesReceived(); // => DLP [Xman] (moved down) - sFrQlXeRt
	...
	if(sender->GetMessagesReceived()==0 &&	//it's the first message we receive
		sender->IsFriend()==false &&		//and it isn't a friend
