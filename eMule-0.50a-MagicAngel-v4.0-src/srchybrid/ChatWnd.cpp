...
void CChatWnd::ShowFriendMsgDetails(CFriend* pFriend)
{
	if (pFriend)
	{
		// gomez82 >>>  XMan::quick fix: some leechers(I think) can cause a crash here, a simple try catch should do the job
		try
		{
		// gomez82 <<< 
...
{
	// gomez82 >>> TuxMan::ClearMessageField
	CString strMessage;
