...
enum EClientSoftware{
	...
	SO_EMULEPLUS		= 5,	// => Enhanced Client Recognization [Spike2] - sFrQlXeRt
	SO_HYDRANODE		= 6,	// => Enhanced Client Recognization [Spike2] - sFrQlXeRt
	...
	SO_MLDONKEY3		= 152,
	SO_OLD_MLDONKEY,
	// <== Enhanced Client Recognization [Spike2] - sFrQlXeR
	SO_URL,
	SO_UNKNOWN
};
