...
//MagicAngel ==> Change Preview submenu/menuitem display logic
#include "MenuCmds.h"
#if defined _BETA || defined _DEBUG
enum FileMenuItemType : UINT
{
	e_preview = MP_PREVIEW;
	e_dlprvprt = MP_TRY_TO_GET_PREVIEW_PARTS;
//	e_pause = MP_PAUSEONPREVIEW; //maybe used in the future
	e_submenu = 0;
}
#else
#define e_preview MP_PREVIEW
#define e_dlprvprt MP_TRY_TO_GET_PREVIEW_PARTS
//#define e_pause MP_PAUSEONPREVIEW
#define e_submenu 0
#define FileMenuItemType UINT
#endif
//MagicAngel <== Change Preview submenu/menuitem display logic