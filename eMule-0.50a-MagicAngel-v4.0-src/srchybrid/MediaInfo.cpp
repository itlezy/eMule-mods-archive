...
#ifdef HAVE_WMSDK_H
#include <wmsdk.h>
#if !defined(HAVE_VISTA_SDK) || _MSC_VER==1500 //zz_fly :: for compile
...
CString GetVideoFormatDisplayName(DWORD biCompression)
{
	...
	// X-Ray :: MoreFourCCCodes :: Start - added by yumeyao
	//else if (IsEqualFOURCC(biCompression, MAKEFOURCC('H','2','6','4')))	strFormat = CStringA((LPCSTR)&biCompression, 4) + " (MPEG-4 AVC)";
	else if (IsEqualFOURCC(biCompression, MAKEFOURCC('H','2','6','4'))
		||	 IsEqualFOURCC(biCompression, MAKEFOURCC('A','V','C','1'))
