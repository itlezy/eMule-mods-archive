...
// ==> Magic Angel Modname - sFrQlXeRt
#define MOD_VERSION_MJR		4
#define MOD_VERSION_MIN		0
#define MOD_VERSION_BUILD   0
#define	MOD_VERSION			_T("Magic Angel")
#define	MOD_VERSION_LONG	_T("Magic Angel v")
// <== Magic Angel Modname - sFrQlXeRt
...
#define	MOD_MORPH_VERSION			_T("MorphXT")
#define	MOD_MORPH_VERSION_LONG	_T("MorphXT v")
