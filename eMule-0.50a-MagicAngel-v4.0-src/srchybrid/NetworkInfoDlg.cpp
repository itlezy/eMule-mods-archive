...
//	if (bFullInfo) // - Always show Client info
//	{
		///////////////////////////////////////////////////////////////////////////
		// Ports Info
		///////////////////////////////////////////////////////////////////////////
	...
	if (bFullInfo) // Only show Userhash if bFullInfo is true.
	{
...
//		rCtrl << _T("UDP-") << GetResString(IDS_PORT) << _T(":\t") << thePrefs.GetUDPPort() << _T("\r\n");
		rCtrl << _T("TCP ") << GetResString(IDS_PORT) << _T(":\t") << thePrefs.GetPort() << _T("\r\n"); // In some languages, hyphens(-) are not preferable
		rCtrl << _T("UDP ") << GetResString(IDS_PORT) << _T(":\t") << thePrefs.GetUDPPort() << _T("\r\n");
		rCtrl << _T("\r\n");
//	}
...
//			if (srv->GetConnPort() != srv->GetPort())  
	...
	// Web Interface
	///////////////////////////////////////////////////////////////////////////
	if (thePrefs.GetWSIsEnabled()) {//It's not a primary part, don't show it if it is not enabled
	rCtrl.SetSelectionCharFormat(rcfBold);
...
//	}
	...
	// Wap Interface
	///////////////////////////////////////////////////////////////////////////
	if (thePrefs.GetWapServerEnabled()) {//It's not a primary part, don't show it if it is not enabled
	rCtrl.SetSelectionCharFormat(rcfBold);
