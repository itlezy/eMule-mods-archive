	...
	, m_ctrlTreeOptions(theApp.m_iDfltImageListColorFlags)
{
	...
	m_htiESCredit = NULL;
	m_htiMagicAngelCredit = NULL; // => Magic Angel Creditsystem - sFrQlXeRt
	m_htiMagicAngelPlusCredit = NULL; // => Magic Angel+ Creditsystem - sFrQlXeRt
	...
	m_htiFairPlay = NULL; //EastShare	- FairPlay by AndCycle
...
void CPPgEastShare::DoDataExchange(CDataExchange* pDX)
{
	...
	if (!m_bInitializedTreeOpts)
	{
		...
		m_htiRatioCredit = m_ctrlTreeOptions.InsertRadioButton(GetResString(IDS_RATIO_CREDIT), m_htiCreditSystem, m_iCreditSystem == 4); // => ReAdded Ratio Creditsystem - sFrQlXeRt
		m_htiMagicAngelCredit = m_ctrlTreeOptions.InsertRadioButton(GetResString(IDS_MAGICANGEL_CREDIT), m_htiCreditSystem, m_iCreditSystem == 5); // => Magic Angel Creditsystem - sFrQlXeRt
		m_htiMagicAngelPlusCredit = m_ctrlTreeOptions.InsertRadioButton(GetResString(IDS_MAGICANGEL_PLUS_CREDIT), m_htiCreditSystem, m_iCreditSystem == 6); // => Magic Angel+ Creditsystem - sFrQlXeRt
		*/
		...
		m_htiMagicAngelCredit = m_ctrlTreeOptions.InsertRadioButton(GetResString(IDS_MAGICANGEL_CREDIT), m_htiCreditSystem, m_iCreditSystem == CS_MAGICANGEL); // => Magic Angel Creditsystem - sFrQlXeRt
		m_htiMagicAngelPlusCredit = m_ctrlTreeOptions.InsertRadioButton(GetResString(IDS_MAGICANGEL_PLUS_CREDIT), m_htiCreditSystem, m_iCreditSystem == CS_MAGICANGELPLUS); // => Magic Angel+ Creditsystem - sFrQlXeRt
		...
		m_htiXtremeCredit = m_ctrlTreeOptions.InsertRadioButton(GetResString(IDS_XTREME_CREDIT), m_htiCreditSystem, m_iCreditSystem == CS_XTREME);
