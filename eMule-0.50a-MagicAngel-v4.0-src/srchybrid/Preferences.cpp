...
// =====> Magic Angel - sFrQlXeRt
uint32	CPreferences::m_uMagicAngelVerCheckLastAutomatic; // => Magic Angel version check - sFrQlXeRt
UINT	CPreferences::m_iBufferTimeLimit; //==> Buffer Time Limit - sFrQlXeRt - evcz
...
bool    CPreferences::EmuLphant;
bool    CPreferences::EmuCommunityNickAddons;
bool	CPreferences::m_bLogEmulator;
// <== Emulate others by WiZaRd/Spike/shadow2004 - sFrQlXeRt

// ==> Release Boost - sFrQlXeRt
bool	CPreferences::m_bIsReleaseBoost;
uint16	CPreferences::m_iGetReleaseBoost;
// <== Release Boost - sFrQlXeRt

// ==> Push Files [sivka/NeoMule] - sFrQlXeRt
bool	CPreferences::m_bPushSmallFiles;
int		CPreferences::m_iPushSmallFilesSize;
bool	CPreferences::m_bPushRareFiles;
int		CPreferences::m_iPushRareFilesValue;
bool	CPreferences::m_bPushRatioFiles;
int		CPreferences::m_iPushRatioFilesValue;
// <== Push Files [sivka/NeoMule] - sFrQlXeRt

// ==> Reask Tweaks - sFrQlXeRt
bool	CPreferences::m_breaskSourceAfterIPChange;  // => Reask Sources after IP Change v4 [Xman] - sFrQlXeRt
bool	CPreferences::m_bSpreadReask; // => manual enable spread reask - sFrQlXeRt
uint32	CPreferences::m_uReAskTimeDif; // => Timer for ReAsk File Sources [Stulle] - sFrQlXeRt
// <== Reask Tweaks - sFrQlXeRt

// ==> Quickstart [DavidXanatos] - sFrQlXeRt
bool	CPreferences::m_bQuickStart;
int		CPreferences::m_iQuickStartTime;
int		CPreferences::m_iQuickStartTimePerFile;
int		CPreferences::m_iQuickMaxConperFive;
int		CPreferences::m_iQuickMaxHalfOpen;
int		CPreferences::m_iQuickMaxConnections;
bool	CPreferences::m_bQuickStartOnIPChange;

bool	CPreferences::m_bOnQuickStart;
// <== Quickstart [DavidXanatos] - sFrQlXeRt
...
int		CPreferences::m_iColoredUpload;
bool	CPreferences::m_bColorQueue;
bool	CPreferences::m_bColorKnownClients;
bool	CPreferences::m_bDontShowMorphColors;
// <== Colored Upload - sFrQlXeRt

bool	CPreferences::m_bUseIntelligentFlush; //==sFrQlXeRt=> Intelligent Filebuffer Flushing [WiZaRd]
bool	CPreferences::m_bReconnectKadOnIpChange; //==sFrQlXeRt=> Reconncect Kad on IP change [Xman]
// <===== Magic Angel - sFrQlXeRt

// =====> Angel Argos - sFrQlXeRt
bool	CPreferences::m_bInformLeechers; // => Inform Leechers - sFrQlXeRt
CString	CPreferences::m_strInformLeechersText; // => Inform Leechers Text - evcz
bool	CPreferences::m_bDontBanFriends;
bool	CPreferences::m_bDisPSForLeechers;
// ==> Anti Upload Protection - sFrQlXeRt
bool	CPreferences::m_bAntiUploadProtection;
uint16	CPreferences::m_iUploadProtectionLimit;
// <== Anti Upload Protection - sFrQlXeRt
...
bool	CPreferences::m_bDetectModstrings;
bool	CPreferences::m_bDetectUsernames;
bool	CPreferences::m_bDetectUserhashes;
int		CPreferences::m_iGplBreakerPunishment;
int		CPreferences::m_iHardLeecherPunishment;
int		CPreferences::m_iSoftLeecherPunishment;
int		CPreferences::m_iBadModPunishment;
bool	CPreferences::m_bDetectWrongHello;
int		CPreferences::m_iWrongHelloPunishment;
bool	CPreferences::m_bDetectBadHello;
int		CPreferences::m_iBadHelloPunishment;
bool	CPreferences::m_bDetectCreditHack;
int		CPreferences::m_iCreditHackPunishment;
bool	CPreferences::m_bDetectModThief;
int		CPreferences::m_iModThiefPunishment;
bool	CPreferences::m_bDetectNickThief;
int		CPreferences::m_iNickThiefPunishment;
bool	CPreferences::m_bDetectFakeEmule;
int		CPreferences::m_iFakeEmulePunishment;
bool	CPreferences::m_bDetectGhostMod;
int		CPreferences::m_iGhostModPunishment;
bool	CPreferences::m_bDetectSpam;
int		CPreferences::m_iSpamPunishment;
bool	CPreferences::m_bDetectEmcrypt;
int		CPreferences::m_iEmcryptPunishment;
bool	CPreferences::m_bDetectXSExploiter;
int		CPreferences::m_iXSExploiterPunishment;
bool	CPreferences::m_bDetectFileFaker;
int		CPreferences::m_iFileFakerPunishment;
...
int		CPreferences::m_iAgressivePunishment;
// <== Sivka-Ban [cyrex2001] - sFrQlXeRt

// ==> Punish Donkeys - sFrQlXeRt
bool	CPreferences::m_bPunishMlDonkey;
bool	CPreferences::m_bPunishEdonkey;
bool	CPreferences::m_bPunishEdonkeyHybrid;
bool	CPreferences::m_bPunishShareaza;
bool	CPreferences::m_bPunishLphant;
bool	CPreferences::m_bPunishSuiFailed;
int		CPreferences::m_iDonkeyPunishment;
// <== Punish Donkeys - sFrQlXeRt
// <===== Angel Argos - sFrQlXeRt
...
CPreferences::CPreferences()
{
	...
	m_iDbgHeap = 1;
#endif
	m_bOnQuickStart = false; // => Quickstart [DavidXanatos] - sFrQlXeRt
}
...
void CPreferences::SetStandartValues()
{
	...
	m_uMagicAngelVerCheckLastAutomatic = 0;  // => Magic Angel version check - sFrQlXeRt
//	Save();
}
...
void CPreferences::SavePreferences()
{
	...
	*/
	...
	// =====> Magic Angel - sFrQlXeRt
	ini.WriteInt(L"MagicAngelVerCheckLastAutomatic", m_uMagicAngelVerCheckLastAutomatic);  // => Magic Angel version check - sFrQlXeRt
	ini.WriteInt(L"BufferTimeLimit", m_iBufferTimeLimit); // ==> Buffer Time Limit sFrQlXeRt - evcz

	// ==> Emulate others by WiZaRd/Spike/shadow2004 - sFrQlXeRt
	ini.WriteBool(L"EmuMLDonkey", EmuMLDonkey);
	ini.WriteBool(L"EmueDonkey", EmueDonkey);
	ini.WriteBool(L"EmueDonkeyHybrid", EmueDonkeyHybrid);
	ini.WriteBool(L"EmuShareaza", EmuShareaza);
	ini.WriteBool(L"EmuLphant", EmuLphant);
	ini.WriteBool(L"EmuCommunityNickAddons", EmuCommunityNickAddons);
	ini.WriteBool(L"LogEmulator", m_bLogEmulator);
	// <== Emulate others by WiZaRd/Spike/shadow2004 - sFrQlXeRt

	// ==> Release Boost - sFrQlXeRt
	ini.WriteBool(L"EnableReleaseBoost", m_bIsReleaseBoost);
	ini.WriteInt(L"ReleaseBoost", m_iGetReleaseBoost);
	// <== Release Boost - sFrQlXeRt
	...
	// ==> Reask Tweaks - sFrQlXeRt
	ini.WriteBool(L"ReaskSourcesAfterIPChange",m_breaskSourceAfterIPChange); // => Reask Sources after IP Change v4 [Xman] - sFrQlXeRt
	ini.WriteBool(L"SpreadReask", m_bSpreadReask); // => manual enable spread reask - sFrQlXeRt
	// ==> Timer for ReAsk File Sources [Stulle] - sFrQlXeRt
	uint8 m_uTemp;
	if(thePrefs.SpreadReask())
		m_uTemp = (uint8)((m_uReAskTimeDif+FILEREASKTIME)/60000);
	else
		m_uTemp = (uint8)(m_uReAskTimeDif/60000);
	...
	ini.WriteBool(L"QuickStartOnIPChange", m_bQuickStartOnIPChange);
	// <== Quickstart [DavidXanatos] - sFrQlXeRt
	...
	// ==> Colored Upload - sFrQlXeRt
	ini.WriteInt(L"ColoredUpload", m_iColoredUpload);
	ini.WriteBool(L"ColorQueue", m_bColorQueue);
	ini.WriteBool(L"ColorKnownClients", m_bColorKnownClients);
	ini.WriteBool(L"DontShowMorphColors", m_bDontShowMorphColors);
	// <== Colored Upload - sFrQlXeRt

	ini.WriteBool(L"UseIntelligentFlush", m_bUseIntelligentFlush); //==sFrQlXeRt=> Intelligent Filebuffer Flushing [WiZaRd]
	ini.WriteBool(L"ReconnectKadOnIpChange", m_bReconnectKadOnIpChange); //==sFrQlXeRt=> Reconncect Kad on IP change [Xman]
	// <===== Magic Angel - sFrQlXeRt

	// =====> Angel Argos - sFrQlXeRt
	ini.WriteBool(L"InformLeechers", m_bInformLeechers); // => Inform Leechers - sFrQlXeRt
	ini.WriteString(L"InformLeechersText", m_strInformLeechersText); // => Inform Leechers Text - evcz
	ini.WriteBool(L"DontBanFriends", m_bDontBanFriends);
	ini.WriteBool(L"DisPSForLeechers", m_bDisPSForLeechers);
	// ==> Anti Upload Protection - sFrQlXeRt
	ini.WriteBool(L"AntiUploadProtection", m_bAntiUploadProtection);
	ini.WriteInt(L"UploadProtectionLimit", m_iUploadProtectionLimit);
	// <== Anti Upload Protection - sFrQlXeRt
	// ==> Anti Uploader Ban [Stulle] - sFrQlXeRt
	...
	ini.WriteBool(L"DetectModstrings", m_bDetectModstrings);
	ini.WriteBool(L"DetectUsernames", m_bDetectUsernames);
	ini.WriteBool(L"DetectUserhashes", m_bDetectUserhashes);
	ini.WriteInt(L"GplBreakerPunishment", m_iGplBreakerPunishment);
	ini.WriteInt(L"HardLeecherPunishment", m_iHardLeecherPunishment);
	ini.WriteInt(L"SoftLeecherPunishment", m_iSoftLeecherPunishment);
	ini.WriteInt(L"BadModPunishment", m_iBadModPunishment);
	ini.WriteBool(L"DetectWrongHello", m_bDetectWrongHello);
	ini.WriteInt(L"WrongHelloPunishment", m_iWrongHelloPunishment);
	ini.WriteBool(L"DetectBadHello", m_bDetectBadHello);
	ini.WriteInt(L"BadHelloPunishment", m_iBadHelloPunishment);
	ini.WriteBool(L"DetectCreditHack", m_bDetectCreditHack);
	ini.WriteInt(L"CreditHackPunishment", m_iCreditHackPunishment);
	ini.WriteBool(L"DetectModThief", m_bDetectModThief);
	ini.WriteInt(L"ModThiefPunishment", m_iModThiefPunishment);
	ini.WriteBool(L"DetectNickThief", m_bDetectNickThief);
	ini.WriteInt(L"NickThiefPunishment", m_iNickThiefPunishment);
	ini.WriteBool(L"DetectFakeEmule", m_bDetectFakeEmule);
	ini.WriteInt(L"FakeEmulePunishment", m_iFakeEmulePunishment);
	ini.WriteBool(L"DetectGhostMod", m_bDetectGhostMod);
	ini.WriteInt(L"GhostModPunishment", m_iGhostModPunishment);
	ini.WriteBool(L"DetectSpam", m_bDetectSpam);
	ini.WriteInt(L"SpamPunishment", m_iSpamPunishment);
	ini.WriteBool(L"DetectEmcrypt", m_bDetectEmcrypt);
	ini.WriteInt(L"EmcryptPunishment", m_iEmcryptPunishment);
	ini.WriteBool(L"DetectXSExploiter", m_bDetectXSExploiter);
	ini.WriteInt(L"XSExploiterPunishment", m_iXSExploiterPunishment);
	ini.WriteBool(L"DetectFileFaker", m_bDetectFileFaker);
	ini.WriteInt(L"FileFakerPunishment", m_iFileFakerPunishment);
	...
	ini.WriteInt(L"AgressivePunishment", m_iAgressivePunishment);
	// <== Sivka-Ban [cyrex2001] - sFrQlXeRt

	// ==> Punish Donkeys - sFrQlXeRt
	ini.WriteBool(L"PunishMlDonkey", m_bPunishMlDonkey);
	ini.WriteBool(L"PunishEdonkey", m_bPunishEdonkey);
	ini.WriteBool(L"PunishEdonkeyHybrid", m_bPunishEdonkeyHybrid);
	ini.WriteBool(L"PunishShareaza", m_bPunishShareaza);
	ini.WriteBool(L"PunishLphant", m_bPunishLphant);
	ini.WriteBool(L"PunishSuiFailed", m_bPunishSuiFailed);
	ini.WriteInt(L"DonkeyPunishment", m_iDonkeyPunishment);
	// <===== Angel Argos - sFrQlXeRt
}
...
// gomez82 >>> vs2005 fixed Warnings
	//MORPH START - Added by SiRoB, (SUC) & (USS)
	minupload = min(max(minupload,1),(UINT)maxGraphUploadRate); //MORPH uint16 is not enough
	//MORPH END   - Added by SiRoB, (SUC) & (USS)
	maxupload=ini.GetInt(L"MaxUpload",UNLIMITED); //MORPH uint16 is not enough
	if (maxupload > (UINT)maxGraphUploadRate && maxupload != UNLIMITED)
		maxupload = ((UINT)maxGraphUploadRate  / 5 * 4); //MORPH uint16 is not enough
	
	maxdownload=ini.GetInt(L"MaxDownload", UNLIMITED); //MORPH uint16 is not enough
	if (maxdownload > (UINT)maxGraphDownloadRate && maxdownload != UNLIMITED)
		maxdownload = ((UINT)maxGraphDownloadRate /5 * 4); //MORPH uint16 is not enoug
// gomez82 <<< vs2005 fixed Warnings
  ...
  // MORPH END leuk_he upnp bindaddr
	...
	if (m_bEnableVerboseOptions)
	{
		...
		// MORPH START - Added by Commander, WebCache 1.2e
		m_bLogICHEvents=ini.GetBool(L"LogICHEvents",true);//JP log ICH events
		// MORPH END - Added by Commander, WebCache 1.2e
	}
	else
	{
	...
	if (m_iFileBufferSize == 0)
		...
		m_iFileBufferSize = 1024*1024*4;  // ==> HDD protect - sFrQlXeRt - evcz
	else
...
//	resumeSameCat=ini.GetBool(L"ResumeNextFromSameCat",false);
	...
	*/
	...
	_stprintf(UpdateURLFakeList,L"%s",ini.GetString(L"UpdateURLFakeList",L"http://emulepawcio.sourceforge.net/nieuwe_site/Ipfilter_fakes/fakes.zip"));		//MORPH START - Added by milobac and Yun.SF3, FakeCheck, FakeReport, Auto-updating
	_stprintf(UpdateURLIPFilter,L"%s",ini.GetString(L"UpdateURLIPFilter",L"http://emulepawcio.sourceforge.net/nieuwe_site/Ipfilter_fakes/ipfilter.rar"));//MORPH START added by Yun.SF3: Ipfilter.dat update
  ...
  m_bCryptLayerRequiredStrictServer = ini.GetBool(L"CryptLayerRequiredStrictServer",false); // MORPH lh require obfuscated server connection 
	...
	// <== new credit system - Stulle
	// =====> Magic Angel - sFrQlXeRt
	m_uMagicAngelVerCheckLastAutomatic = ini.GetInt(L"MagicAngelVerCheckLastAutomatic", 0);  // => Magic Angel version check - sFrQlXeRt
	m_iBufferTimeLimit=ini.GetInt(L"BufferTimeLimit",10); // ==> Buffer Time Limit sFrQlXeRt - evcz

	// ==> Emulate others by WiZaRd/Spike/shadow2004 - sFrQlXeRt
	EmuMLDonkey = ini.GetBool(L"EmuMLDonkey", false);
	EmueDonkey= ini.GetBool(L"EmueDonkey", false);
	EmueDonkeyHybrid= ini.GetBool(L"EmueDonkeyHybrid", false);
	EmuShareaza= ini.GetBool(L"EmuShareaza", false);
	EmuLphant= ini.GetBool(L"EmuLphant", false);
	EmuCommunityNickAddons= ini.GetBool(L"EmuCommunityNickAddons", false);
	m_bLogEmulator= ini.GetBool(L"LogEmulator", false);
	// <== Emulate others by WiZaRd/Spike/shadow2004 - sFrQlXeRt

	// ==> Release Boost - sFrQlXeRt
	m_bIsReleaseBoost = ini.GetBool(L"EnableReleaseBoost", false);
	m_iGetReleaseBoost = (uint16)ini.GetInt(L"ReleaseBoost", 5);
	m_iGetReleaseBoost = (m_iGetReleaseBoost >= 2 && m_iGetReleaseBoost <= 20) ? m_iGetReleaseBoost : 29;
	// <== Release Boost - sFrQlXeRt

	// ==> Push Files [sivka/NeoMule] - sFrQlXeRt
	m_bPushSmallFiles = ini.GetBool(L"PushSmallFiles", false);
	m_iPushSmallFilesSize = ini.GetInt(L"PushSmallFilesSize", 9216);
	m_iPushSmallFilesSize = (m_iPushSmallFilesSize >= 1024 && m_iPushSmallFilesSize <= 18432) ? m_iPushSmallFilesSize : 9216;
	m_bPushRareFiles = ini.GetBool(L"PushRareFiles", false);
	m_iPushRareFilesValue = ini.GetInt(L"PushRareFilesValue", 10);
	m_iPushRareFilesValue = (m_iPushRareFilesValue >= 4 && m_iPushRareFilesValue <= 25) ? m_iPushRareFilesValue : 10;
	m_bPushRatioFiles = ini.GetBool(L"PushRatioFiles", false);
	m_iPushRatioFilesValue = ini.GetInt(L"PushRatioFilesValue", 10);
	m_iPushRatioFilesValue = (m_iPushRatioFilesValue >= 2 && m_iPushRatioFilesValue <= 20) ? m_iPushRatioFilesValue : 10;
	// <== Push Files [sivka/NeoMule] - sFrQlXeRt

	// ==> Reask Tweaks - sFrQlXeRt
	m_breaskSourceAfterIPChange = ini.GetBool(L"ReaskSourcesAfterIPChange", false); // => Reask Sources after IP Change v4 [Xman] - sFrQlXeRt
	m_bSpreadReask = ini.GetBool(L"SpreadReask", false); // => manual enable spread reask - sFrQlXeRt
	// ==> Timer for ReAsk File Sources [Stulle] - sFrQlXeRt
	m_uTemp = ini.GetInt(L"ReAskTime",29);
	m_uTemp = (m_uTemp >= 29 && m_uTemp <= 57) ? m_uTemp : 29;
	if(thePrefs.SpreadReask())
		m_uReAskTimeDif = (m_uTemp-29)*60000;
	else
		m_uReAskTimeDif = m_uTemp*60000;
	// <== Timer for ReAsk File Sources [Stulle] - sFrQlXeRt
	// <== Reask Tweaks - sFrQlXeRt

	// ==> Quickstart [DavidXanatos] - sFrQlXeRt
	m_bQuickStart = ini.GetBool(L"QuickStart", false);
	m_iQuickStartTime = ini.GetInt(L"QuickStartTime", 15);
	m_iQuickStartTimePerFile = ini.GetInt(L"QuickStartTimePerFile", 75);
	m_iQuickMaxConperFive = ini.GetInt(L"QuickMaxConperFive", (int)(MaxConperFive*1.5));
	m_iQuickMaxHalfOpen = ini.GetInt(L"QuickMaxHalfOpen", (int)(maxhalfconnections*1.5));
	m_iQuickMaxConnections = ini.GetInt(L"QuickMaxConnections", (int)(maxconnections*1.5));
	m_bQuickStartOnIPChange = ini.GetBool(L"QuickStartOnIPChange", false);

	m_iQuickStartTime = ini.GetInt(L"QuickstartTime", 15);
	m_iQuickStartTime = (m_iQuickStartTime >= 5 && m_iQuickStartTime <= 25) ? m_iQuickStartTime : 15;
	m_iQuickStartTimePerFile = ini.GetInt(L"QuickStartTimePerFile", 75);
	m_iQuickStartTimePerFile = (m_iQuickStartTimePerFile >= 30 && m_iQuickStartTimePerFile <= 150) ? m_iQuickStartTimePerFile : 75;
	// <== Quickstart [DavidXanatos] - sFrQlXeRt

	// ==> FunnyNick Tag [Stulle] - sFrQlXeRt
	FnTagMode = (uint8)ini.GetInt(L"FnTagMode", 2);
	_stprintf (m_sFnCustomTag,L"%s",ini.GetString (L"FnCustomTag"));
	m_bFnTagAtEnd = ini.GetBool(L"FnTagAtEnd", false);
	// <== FunnyNick Tag [Stulle] - sFrQlXeRt

	// ==> Colored Upload - sFrQlXeRt
	m_iColoredUpload = ini.GetInt(L"ColoredUpload", 0);
	m_bColorQueue = ini.GetBool(L"ColorQueue", false);
	m_bColorKnownClients = ini.GetBool(L"ColorKnownClients", false);
	m_bDontShowMorphColors = ini.GetBool(L"DontShowMorphColors", false);
	// <== Colored Upload - sFrQlXeRt

	m_bUseIntelligentFlush = ini.GetBool(L"UseIntelligentFlush", true); //==sFrQlXeRt=> Intelligent Filebuffer Flushing [WiZaRd]
	m_bReconnectKadOnIpChange = ini.GetBool(L"ReconnectKadOnIpChange", true); //==sFrQlXeRt=> Reconncect Kad on IP change [Xman]
	// <===== Magic Angel - sFrQlXeRt

	// =====> Angel Argos - sFrQlXeRt
	m_bInformLeechers = ini.GetBool(L"InformLeechers", false); // => Inform Leechers - sFrQlXeRt
	m_strInformLeechersText = ini.GetString(L"InformLeechersText", NULL); // => Inform Leechers Text - evcz
	m_bDontBanFriends = ini.GetBool(L"DontBanFriends", false);
	m_bDisPSForLeechers = ini.GetBool(L"DisPSForLeechers", true);
	// ==> Anti Upload Protection - sFrQlXeRt
	m_bAntiUploadProtection = ini.GetBool(L"AntiUploadProtection", false);
	m_iUploadProtectionLimit = (uint16)ini.GetInt(L"UploadProtectionLimit", 1800);
	m_iUploadProtectionLimit = (m_iUploadProtectionLimit >= 1000 && m_iUploadProtectionLimit <= 2800) ? m_iUploadProtectionLimit : 1800;
	// <== Anti Upload Protection - sFrQlXeRt
	// ==> Anti Uploader Ban [Stulle] - sFrQlXeRt
	m_iAntiUploaderBanLimit = (uint16)ini.GetInt(L"AntiUploaderBanLimit", 8000);
	AntiUploaderBanCaseMode = (uint8)ini.GetInt(L"AntiUploaderBanCaseMode", 1);
	// <== Anti Uploader Ban [Stulle] - sFrQlXeRt

	m_bDetectModstrings = ini.GetBool(L"DetectModstrings", true);
	m_bDetectUsernames = ini.GetBool(L"DetectUsernames", false);
	m_bDetectUserhashes = ini.GetBool(L"DetectUserhashes", false);
	m_iGplBreakerPunishment = ini.GetInt(L"GplBreakerPunishment", 1);
	m_iHardLeecherPunishment = ini.GetInt(L"HardLeecherPunishment", 1);
	m_iSoftLeecherPunishment = ini.GetInt(L"SoftLeecherPunishment", 2);
	m_iBadModPunishment = ini.GetInt(L"BadModPunishment", 1);
	m_bDetectWrongHello = ini.GetBool(L"DetectWrongHello", true);
	m_iWrongHelloPunishment = ini.GetInt(L"WrongHelloPunishment", 2);
	m_bDetectBadHello = ini.GetBool(L"DetectBadHello", true);
	m_iBadHelloPunishment = ini.GetInt(L"BadHelloPunishment", 1);
	m_bDetectCreditHack = ini.GetBool(L"DetectCreditHack", true);
	m_iCreditHackPunishment = ini.GetInt(L"CreditHackPunishment", 1);
	m_bDetectModThief = ini.GetBool(L"DetectModThief", true);
	m_iModThiefPunishment = ini.GetInt(L"ModThiefPunishment", 2);
	m_bDetectNickThief = ini.GetBool(L"DetectNickThief", true);
	m_iNickThiefPunishment = ini.GetInt(L"NickThiefPunishment", 3);
	m_bDetectFakeEmule = ini.GetBool(L"DetectFakeEmule", true);
	m_iFakeEmulePunishment = ini.GetInt(L"FakeEmulePunishment", 1);
	m_bDetectGhostMod = ini.GetBool(L"DetectGhostMod", false);
	m_iGhostModPunishment = ini.GetInt(L"GhostModPunishment", 2);
	m_bDetectSpam = ini.GetBool(L"DetectSpam", true);
	m_iSpamPunishment = ini.GetInt(L"SpamPunishment", 1);
	m_bDetectEmcrypt = ini.GetBool(L"DetectEmcrypt", true);
	m_iEmcryptPunishment = ini.GetInt(L"EmcryptPunishment", 2);
	m_bDetectXSExploiter = ini.GetBool(L"DetectXSExploiter", true);
	m_iXSExploiterPunishment = ini.GetInt(L"XSExploiterPunishment", 2);
	m_bDetectFileFaker = ini.GetBool(L"DetectFileFaker", true);
	m_iFileFakerPunishment = ini.GetInt(L"FileFakerPunishment", 2);
	...
	m_bAgressiveLog = ini.GetBool(L"AgressiveLog", false);
	m_iAgressivePunishment = ini.GetInt(L"AgressivePunishment", 3);
	// <== Sivka-Ban [cyrex2001] - sFrQlXeRt

	// ==> Punish Donkeys - sFrQlXeRt
	m_bPunishMlDonkey = ini.GetBool(L"PunishMlDonkey", false);
	m_bPunishEdonkey = ini.GetBool(L"PunishEdonkey", false);
	m_bPunishEdonkeyHybrid = ini.GetBool(L"PunishEdonkeyHybrid", false);
	m_bPunishShareaza = ini.GetBool(L"PunishShareaza", false);
	m_bPunishLphant = ini.GetBool(L"PunishLphant", false);
	m_bPunishSuiFailed = ini.GetBool(L"PunishSuiFailed", false);
	m_iDonkeyPunishment = ini.GetInt(L"DonkeyPunishment", 0);
	// <== Punish Donkeys - sFrQlXeRt
	// <===== Angel Argos - sFrQlXeRt
...
// ==> Magic Angel version check - sFrQlXeRt
void CPreferences::UpdateLastMAVC()
{
	struct tm tmTemp; // gomez82 >>> vs2005 fixed Warning
	m_uMagicAngelVerCheckLastAutomatic = safe_mktime(CTime::GetCurrentTime().GetLocalTm(&tmTemp)); // gomez82 >>> vs2005 fixed Warning
}
// <== Magic Angel version check - sFrQlXeRt
...
{
	if(strURL.IsEmpty())
		strURL = _T("http://emulepawcio.sourceforge.net/nieuwe_site/Ipfilter_fakes/ipfilter.rar");
