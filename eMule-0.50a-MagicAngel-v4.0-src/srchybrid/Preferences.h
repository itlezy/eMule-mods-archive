...
public:
   ...
   // MORPH END  leuk_he Advanced official preferences. 
	...
	static uint32	m_uMagicAngelVerCheckLastAutomatic; // => Magic Angel version check - sFrQlXeRt
	static	UINT	m_iBufferTimeLimit; // ==> Buffer Time Limit sFrQlXeRt - evcz
	...
	static  bool    EmuLphant;
	static  bool    EmuCommunityNickAddons;
	static	bool	m_bLogEmulator;
	// <== Emulate others by WiZaRd/Spike/shadow2004 - sFrQlXeRt

	// ==> Release Boost - sFrQlXeRt
	static bool		m_bIsReleaseBoost;
	static uint16	m_iGetReleaseBoost;
	// <== Release Boost - sFrQlXeRt
	...
	static bool		m_breaskSourceAfterIPChange; // => Reask Sources after IP Change v4 [Xman] - sFrQlXeRt
	static bool		m_bSpreadReask; // => manual enable spread reask - sFrQlXeRt
	static uint32	m_uReAskTimeDif; // => Timer for ReAsk File Sources [Stulle] - sFrQlXeRt
	// <== Reask Tweaks - sFrQlXeRt
	...
	static bool		m_bQuickStartOnIPChange;
	...
	static int		m_iColoredUpload;
	static bool		m_bColorQueue;
	static bool		m_bColorKnownClients;
	static bool		m_bDontShowMorphColors;
	// <== Colored Upload - sFrQlXeRt

	static	bool	m_bUseIntelligentFlush; //==sFrQlXeRt=> Intelligent Filebuffer Flushing [WiZaRd]
	static	bool	m_bReconnectKadOnIpChange; //==sFrQlXeRt=> Reconncect Kad on IP change [Xman]
	// <===== Magic Angel - sFrQlXeRt

	// =====> Angel Argos - sFrQlXeRt
	static bool		m_bInformLeechers; // => Inform Leechers - sFrQlXeRt
	static CString	m_strInformLeechersText; // => Inform Leechers Text - evcz
	static bool		m_bDontBanFriends;
	static bool		m_bDisPSForLeechers;
	// ==> Anti Upload Protection - sFrQlXeRt
	static bool		m_bAntiUploadProtection;
	static uint16	m_iUploadProtectionLimit;
	// <== Anti Upload Protection - sFrQlXeRt
	...
	static bool		m_bDetectModstrings;
	static bool		m_bDetectUsernames;
	static bool		m_bDetectUserhashes;
	static int		m_iGplBreakerPunishment;
	static int		m_iHardLeecherPunishment;
	static int		m_iSoftLeecherPunishment;
	static int		m_iBadModPunishment;
	static bool		m_bDetectWrongHello;
	static int		m_iWrongHelloPunishment;
	static bool		m_bDetectBadHello;
	static int		m_iBadHelloPunishment;
	static bool		m_bDetectCreditHack;
	static int		m_iCreditHackPunishment;
	static bool		m_bDetectModThief;
	static int		m_iModThiefPunishment;
	static bool		m_bDetectNickThief;
	static int		m_iNickThiefPunishment;
	static bool		m_bDetectFakeEmule;
	static int		m_iFakeEmulePunishment;
	static bool		m_bDetectGhostMod;
	static int		m_iGhostModPunishment;
	static bool		m_bDetectSpam;
	static int		m_iSpamPunishment;
	static bool		m_bDetectEmcrypt;
	static int		m_iEmcryptPunishment;
	static bool		m_bDetectXSExploiter;
	static int		m_iXSExploiterPunishment;
	static bool		m_bDetectFileFaker;
	static int		m_iFileFakerPunishment;
	...
	static int		m_iAgressivePunishment;
	// <== Sivka-Ban [cyrex2001] - sFrQlXeRt

	// ==> Punish Donkeys - sFrQlXeRt
	static bool		m_bPunishMlDonkey;
	static bool		m_bPunishEdonkey;
	static bool		m_bPunishEdonkeyHybrid;
	static bool		m_bPunishShareaza;
	static bool		m_bPunishLphant;
	static bool		m_bPunishSuiFailed;
	static int		m_iDonkeyPunishment;
	// <== Punish Donkeys - sFrQlXeRt
	// <===== Angel Argos - sFrQlXeRt
   ...
   //Xman disable compression
	...
	//static	UINT	GetMaxConperFive()					{return MaxConperFive;} // => Quickstart [DavidXanatos] - sFrQlXeRt
	...
	*/
	...
	//static	bool	GetEnableAntiCreditHack()					{ return enableAntiCreditHack; }//MORPH - Added by IceCream, enable AntiCreditHack // => Removed Morph Anti-Leecher - sFrQlXeRt
	...
	//MORPH END   - Added by schnulli900, filter clients with failed downloads [Xman]
	//static	bool GetEnableAntiLeecher()		{ return enableAntiLeecher; } //MORPH - Added by IceCream, enable Anti-leecher // => Removed Morph Anti-Leecher - sFrQlXeRt
...
public:
	...
	static	uint32	GetLastMAVC()				{return m_uMagicAngelVerCheckLastAutomatic;}
	static	void	UpdateLastMAVC();
	// <== Magic Angel version check - sFrQlXeRt
	static	UINT	GetBufferTimeLimit()		{return m_iBufferTimeLimit;} // ==> Buffer Time Limit sFrQlXeRt - evcz
	...
	static  bool    IsEmuLphant()				{return EmuLphant;}
	static  bool    IsEmuCommunityNickAddons()				{return EmuCommunityNickAddons;}
	static	bool	IsEmuLog()					{return m_bLogEmulator;}
	// <== Emulate others by WiZaRd/Spike/shadow2004 - sFrQlXeRt

	// ==> Release Boost - sFrQlXeRt
	static bool		IsReleaseBoost()			{ return m_bIsReleaseBoost; }
	static uint16	GetReleaseBoost()			{ return m_iGetReleaseBoost; }
	// <== Release Boost - sFrQlXeRt
	...
	// ==> Reask Tweaks - sFrQlXeRt
	static bool		IsRASAIC()			{return m_breaskSourceAfterIPChange;} // => Reask Sources after IP Change v4 [Xman] - sFrQlXeRt
	static bool		SpreadReask()		{return m_bSpreadReask;} // => manual enable spread reask - sFrQlXeRt
	static uint32	GetReAskTimeDif()	{return m_uReAskTimeDif;} // => Timer for ReAsk File Sources [Stulle] - sFrQlXeRt
	// <== Reask Tweaks - sFrQlXeRt
	...
	static	int		GetQuickStartConperFive()		{return m_iQuickMaxConperFive;}
	static	int		GetQuickStartHalfOpen()			{return m_iQuickMaxHalfOpen;}
	static	int		GetQuickStartMaxConnections()	{return m_iQuickMaxConnections;}
	static	bool	UseQuickStartOnIPChange()		{return m_bQuickStartOnIPChange;}
	...
	// ==> Colored Upload - sFrQlXeRt
	static int		ColoredUpload()				{return m_iColoredUpload;}
	static bool		ColorQueue()				{return m_bColorQueue;}
	static bool		ColorKnownClients()			{return m_bColorKnownClients;}
	static bool		DontShowMorphColors()		{return m_bDontShowMorphColors;}
	// <== Colored Upload - sFrQlXeRt

	static	bool	UseIntelligentFlush()		{return m_bUseIntelligentFlush;} //==sFrQlXeRt=> Intelligent Filebuffer Flushing [WiZaRd]
	static	bool	ReconnectKadOnIpChange()	{return m_bReconnectKadOnIpChange;} //==sFrQlXeRt=> Reconncect Kad on IP change [Xman]
	// <===== Magic Angel - sFrQlXeRt

	// =====> Angel Argos - sFrQlXeRt
	static bool		IsInformLeechers()			{ return m_bInformLeechers; } // => Inform Leechers - sFrQlXeRt
	static CString	GetInformLeechersText()		{ return m_strInformLeechersText; } // => Inform Leechers Text - evcz
	static bool		IsDontBanFriends()			{ return m_bDontBanFriends; }
	static bool		DisPSForLeechers()			{ return m_bDisPSForLeechers; }
	// ==> Anti Upload Protection - sFrQlXeRt
	static bool		IsAntiUploadProtection()	{ return m_bAntiUploadProtection; }
	static uint16	GetUploadProtectionLimit()	{ return m_iUploadProtectionLimit; }
	// <== Anti Upload Protection - sFrQlXeRt
	// ==> Anti Uploader Ban [Stulle] - sFrQlXeRt
	...
	static bool		IsDetectModstrings()		{ return m_bDetectModstrings; }
	static bool		IsDetectUsernames()			{ return m_bDetectUsernames; }
	static bool		IsDetectUserhashes()		{ return m_bDetectUserhashes; }
	static int		GetGplBreakerPunishment()	{ return m_iGplBreakerPunishment; }
	static int		GetHardLeecherPunishment()	{ return m_iHardLeecherPunishment; }
	static int		GetSoftLeecherPunishment()	{ return m_iSoftLeecherPunishment; }
	static int		GetBadModPunishment()		{ return m_iBadModPunishment; }
	static bool		IsDetectWrongHello()		{ return m_bDetectWrongHello; }
	static int		GetWrongHelloPunishment()	{ return m_iWrongHelloPunishment; }
	static bool		IsDetectBadHello()			{ return m_bDetectBadHello; }
	static int		GetBadHelloPunishment()		{ return m_iBadHelloPunishment; }
	static bool		IsDetectCreditHack()		{ return m_bDetectCreditHack; }
	static int		GetCreditHackPunishment()	{ return m_iCreditHackPunishment; }
	static bool		IsDetectModThief()			{ return m_bDetectModThief; }
	static int		GetModThiefPunishment()		{ return m_iModThiefPunishment; }
	static bool		IsDetectNickThief()			{ return m_bDetectNickThief; }
	static int		GetNickThiefPunishment()	{ return m_iNickThiefPunishment; }
	static bool		IsDetectFakeEmule()			{ return m_bDetectFakeEmule; }
	static int		GetFakeEmulePunishment()	{ return m_iFakeEmulePunishment; }
	static bool		IsDetectGhostMod()			{ return m_bDetectGhostMod; }
	static int		GetGhostModPunishment()		{ return m_iGhostModPunishment; }
	static bool		IsDetectSpam()				{ return m_bDetectSpam; }
	static int		GetSpamPunishment()			{ return m_iSpamPunishment; }
	static bool		IsDetectEmcrypt()			{ return m_bDetectEmcrypt; }
	static int		GetEmcryptPunishment()		{ return m_iEmcryptPunishment; }
	static bool		IsDetectXSExploiter()		{ return m_bDetectXSExploiter; }
	static int		GetXSExploiterPunishment()	{ return m_iXSExploiterPunishment; }
	static bool		IsDetectFileFaker()			{ return m_bDetectFileFaker; }
	static int		GetFileFakerPunishment()	{ return m_iFileFakerPunishment; }
	...
	static int		GetAgressivePunishment()	{ return m_iAgressivePunishment; }
	// <== Sivka-Ban [cyrex2001] - sFrQlXeRt

	// ==> Punish Donkeys - sFrQlXeRt
	static bool		IsPunishMlDonkey()			{ return m_bPunishMlDonkey; }
	static bool		IsPunishEdonkey()			{ return m_bPunishEdonkey; }
	static bool		IsPunishEdonkeyHybrid()		{ return m_bPunishEdonkeyHybrid; }
	static bool		IsPunishShareaza()			{ return m_bPunishShareaza; }
	static bool		IsPunishLphant()			{ return m_bPunishLphant; }
	static bool		IsPunishSuiFailed()			{ return m_bPunishSuiFailed;}
	static int		GetDonkeyPunishment()		{ return m_iDonkeyPunishment; }
	// <== Punish Donkeys - sFrQlXeRt
	// <===== Angel Argos - sFrQlXeRt
};
