...
CPreferencesDlg::CPreferencesDlg()
{
   ...
   */
	...
	m_wndMagicAngel.m_psp.dwFlags &= ~PSH_HASHELP; // => Magic Angel preferences window - sFrQlXeRt
	m_wndAngelArgos.m_psp.dwFlags &= ~PSH_HASHELP; // => Angel Argos preferences window - sFrQlXeRt
//MORPH START - Preferences groups [ePlus/Sirob]
/*
...
//MORPH END   - Preferences groups [ePlus/Sirob]
	...
	*/
	...
	AddPage(&m_wndMagicAngel); // => Magic Angel preferences window - sFrQlXeRt
	AddPage(&m_wndAngelArgos); // => Angel Argos preferences window - sFrQlXeRt
...
//MORPH END   - Preferences groups [ePlus/Sirob]
	...
	//NTService                   = 0; //MORPH leuk_he:run as ntservice v1.. //==MagicAngel=> Fixed Morph tab bug - sFrQlXeRt there's no need to initialize this here
	// end tabbed
...
*/
	...
	ImageList.Add(CTempIconLoader(_T("MAGICANGEL"))); // => Magic Angel preferences window - sFrQlXeRt
	ImageList.Add(CTempIconLoader(_T("ANGELARGOS"))); // => Angel Argos preferences window - sFrQlXeRt
...
//MORPH END   - Preferences groups [ePlus/Sirob]
	...
	m_wndMagicAngel.Localize(); // => Magic Angel preferences window - sFrQlXeRt
	m_wndAngelArgos.Localize(); // => Angel Argos preferences window - sFrQlXeRt
...
// advanced...	official. 
	...
	m_slideBar.AddGroupItem(_T("Magic Angel"), iGroup, c++); // => Magic Angel preferences window - sFrQlXeRt
	m_slideBar.AddGroupItem(_T("Angel Argos"), iGroup, c++); // => Angel Argos preferences window - sFrQlXeRt
