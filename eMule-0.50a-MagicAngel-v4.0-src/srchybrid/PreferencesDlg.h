...
#include "MagicAngel\PPgMagicAngel.h" // => Magic Angel preferences window - sFrQlXeRt
#include "MagicAngel\PPgAngelArgos.h" // => Angel Argos preferences window - sFrQlXeRt
...
public:
	...
	CPPgMagicAngel	m_wndMagicAngel; // => Magic Angel preferences window - sFrQlXeRt
	CPPgAngelArgos	m_wndAngelArgos; // => Angel Argos preferences window - sFrQlXeRt
