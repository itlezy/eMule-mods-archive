...
SocketSentBytes CUDPSocket::SendControlData(uint32 maxNumberOfBytesToSend, uint32 /*minFragSize*/) { // ZZ:UploadBandWithThrottler (UDP) //==MagicAngel=> Fixed Morph compiler warning - sFrQlXeRt
// ZZ:UploadBandWithThrottler (UDP) -->
