...
UINT AFX_CDECL CUPnP_IGDControlPoint::RemoveInstance(LPVOID /*pParam*/ ){
...
UINT AFX_CDECL CUPnP_IGDControlPoint::TimerThreadFunc( LPVOID /*pParam*/ ){
...
UINT AFX_CDECL CUPnP_IGDControlPoint::ActionThreadFunc( LPVOID pParam ){
	m_ActionThreadCS.Lock();
