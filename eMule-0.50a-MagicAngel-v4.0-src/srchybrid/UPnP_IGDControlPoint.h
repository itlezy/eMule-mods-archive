...
public:
	...
	*/
	...
	static UINT AFX_CDECL RemoveInstance(LPVOID /*pParam*/ );
private:
	...
	//Threads
	static UINT AFX_CDECL TimerThreadFunc( LPVOID pParam );
	static UINT AFX_CDECL ActionThreadFunc( LPVOID pParam );
