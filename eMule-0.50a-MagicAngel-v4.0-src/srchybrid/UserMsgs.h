...
enum EUserWndMessages
{
	...
	UM_SERVERSTATUS,
	//MORPH START leuk_he run as a ntservice v1
	UM_MAVERSIONCHECK_RESPONSE, // => Magic Angel version check - sFrQlXeRt
	UM_DLPVERSIONCHECK_RESPONSE, // => DLP [Xman] - sFrQlXeRt
	UM_MDLPVERSIONCHECK_RESPONSE, // => MagicDLP - sFrQlXeRt
