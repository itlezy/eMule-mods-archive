...
class CDLP; // => DLP [Xman] - sFrQlXeRt
class CMagicDLP; // => MagicDLP - sFrQlXeRt
...
public:
	...
	CDLP*				dlp; // => DLP [Xman] - sFrQlXeRt
	CMagicDLP*			MagicDLP; // => MagicDLP - sFrQlXeRt
...
public:
	...
	bool	bInternetMaybeDown; // note: I changed this from Xtreme (originally uint8). Should work fine like this too.
	//<=MagicAngel== Reask Sources after IP Change v4 [Xman] - sFrQlXeRt
