...
public:
	...
	void DoMAVersioncheck(bool manual); // => Magic Angel version check - sFrQlXeRt
...
protected:
	...
	char			m_acMAVCDNSBuffer[MAXGETHOSTSTRUCT]; // => Magic Angel version check - sFrQlXeRt
	// ==> DLP [Xman] - sFrQlXeRt
	char			m_acDLPBuffer[MAXGETHOSTSTRUCT]; 
	bool			m_bCheckwasDone;
	// <== DLP [Xman] - sFrQlXeRt
	char			m_acMDLPBuffer[MAXGETHOSTSTRUCT]; // => MagicDLP - sFrQlXeRt
	...
	afx_msg	LRESULT	OnMAVersionCheckResponse(WPARAM wParam, LPARAM lParam);

	// => DLP [Xman] - sFrQlXeRt
	afx_msg LRESULT OnDLPVersionCheckResponse(WPARAM wParam, LPARAM lParam);

	// => MagicDLP - sFrQlXeRt
	afx_msg LRESULT OnMDLPVersionCheckResponse(WPARAM wParam, LPARAM lParam);
