...
#define SHAREAZAEMUVERSION		0x3D // => Emulate others by WiZaRd/Spike/shadow2004 - sFrQlXeRt
#define OP_XSMLDONKEY			0xFA // <2 bytes: no. of sources><HASH 16><sources: IP port IP> //==MagicAngel=> Recognize MlDonkey XS Answer [Spike2/ideas by Wiz] - sFrQlXeRt