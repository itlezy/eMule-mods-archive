...
[Setup]
AppName=eMule
AppVerName=eMule Mephisto 3.0
AppPublisher=Stulle
AppPublisherURL=http://mephisto.emule-web.de/
AppSupportURL=http://forum.emule-project.net/index.php?showforum=97
AppUpdatesURL=https://sourceforge.net/projects/mephisto/files/
...
WizardImageFile=mephisto.bmp
WizardImageStretch=no

; this dir:
OutputDir=.
OutputBaseFilename=mephemuleversion-installer
SetupIconFile=..\srchybrid\res\mephisto_inst_256.ico
Compression=lzma
;fast for debug:
;Compression=zip
...
Source: ..\staging\Changelog.Mephisto.txt; DestDir: {app}; Flags: ignoreversion
...
Filename: {app}\emulemephhome.url; Section: InternetShortcut; Key: URL; String: http://mephisto.emule-web.de/

[Icons]
Name: {group}\eMule Mephisto; Filename: {app}\emule.exe; Comment: eMule Mephisto
Name: {group}\{cm:ProgramOnTheWeb,eMule Mephisto}; Filename: {app}\emulemephhome.url
...
Filename: netsh; Parameters: "firewall add allowedprogram ""{app}\emule.exe"" ""eMule Mephisto"" ENABLE"; flags: runminimized shellexec; Tasks: firewall; OnlyBelowVersion: 0,6
Filename: netsh; Parameters: "advfirewall firewall add rule name=""eMule Mephisto"" dir=in action=allow program=""{app}\emule.exe"" enable=yes description=""eMule Mephisto inbound traffic"" profile=any"; flags: runminimized shellexec; Tasks: firewall; MinVersion: 0,6
Filename: netsh; Parameters: "advfirewall firewall add rule name=""eMule Mephisto"" dir=out action=allow program=""{app}\emule.exe"" enable=yes description=""eMule Mephisto outbound traffic"" profile=any"; flags: runminimized shellexec; Tasks: firewall; MinVersion: 0,6
...
Filename: netsh; Parameters: "advfirewall firewall delete rule name=""eMule Mephisto"" profile=any program=""{app}\emule.exe"""; flags: runminimized shellexec; Tasks: firewall; MinVersion: 0,6


[UninstallDelete]
Type: files; Name: {app}\emulemephhome.url
