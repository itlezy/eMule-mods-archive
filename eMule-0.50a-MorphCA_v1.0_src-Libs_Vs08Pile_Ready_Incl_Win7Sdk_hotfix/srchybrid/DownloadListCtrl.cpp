...
// ZZ:DownloadManager <--
		...
		// MorphCA has 'category' in column 13 and 'added on' in column 12.
...
void CDownloadListCtrl::OnContextMenu(CWnd* /*pWnd*/, CPoint point)
{
	...
	if (iSel != -1)
	{
		...
		if (content != NULL && content->type == FILE_TYPE)
		{
		    ...
		    m_FileMenu.EnableMenuItem((UINT_PTR)m_PreviewMenu.m_hMenu, (iSelectedItems == 1 && iFilesToPreview == 1) ? MF_ENABLED : MF_GRAYED); 
