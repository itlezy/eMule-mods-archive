...
#define	MOD_VERSION			_T("MorphCA")
#define	MOD_VERSION_LONG	_T("MorphCA v")
//END   - This part should not be changed in anyway
static const CString m_strModTag = L"MorphCA"; //>>> WiZaRd::Same ModVersion Detection

#define	MOD_MOD_VERSION		_T("") //Use this to define your version based on MorphCA mod
