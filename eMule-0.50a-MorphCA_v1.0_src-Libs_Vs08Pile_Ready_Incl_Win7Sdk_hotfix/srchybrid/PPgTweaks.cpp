...
//<<< WiZaRd::ClientAnalyzer
//>>> CA
		m_htiLogAnalyzerEvents = m_ctrlTreeOptions.InsertCheckBox(GetResString(IDS_LOG_ANALYZER_EVENTS), m_htiCreditSystem, m_bLogAnalyzerEvents);
//<<< CA
#else
...
//>>> WiZaRd::ClientAnalyzer
        ...
        m_ctrlTreeOptions.SetItemState(m_htiLogAnalyzerEvents, TVIS_BOLD, TVIS_BOLD);
//<<< WiZaRd::ClientAnalyzer
#endif
