...
void CSharedDirsTreeCtrl::InitalizeStandardItems(){
	...
	pAll->m_htItem = InsertItem(TVIF_TEXT | TVIF_PARAM | TVIF_IMAGE | TVIF_SELECTEDIMAGE | TVIF_STATE, GetResString(IDS_ALLSHAREDFILES), 0, 0, 0, 0,/*TVIS_EXPANDED, TVIS_EXPANDED,*/ (LPARAM)pAll, TVI_ROOT, TVI_LAST); 
