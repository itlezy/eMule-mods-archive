...
void CKnownFile::UpdatePartsInfo()
{
	...
	*/
	...
	UpdatePowerShareLimit(m_nVirtualCompleteSourcesCount<=999 || m_nCompleteSourcesCountHi<=GetPartCount(), m_nCompleteSourcesCountHi==1 && m_nVirtualCompleteSourcesCount==0 && iCompleteSourcesCountInfoReceived>1,bPowerShareLimit);//morph4u PS restriction changed -->999
	// <== Limit PS by amount of data uploaded - Stulle
	//MORPH END   - Added by SiRoB, Avoid misusing of powersharing
