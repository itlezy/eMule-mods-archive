...
#define	MP_HM_TOGGLESPEEDGRAPH		150014// X: [SGW] - [SpeedGraphWnd]
#define MP_HM_OPENLOG               150015//open log
#define	MP_HM_QUICKSTART		    150016 // NEO: QS - [QuickStart] <-- Xanatos --
#define	MP_HM_REMOVEALLBANNEDCLIENTS	150017
