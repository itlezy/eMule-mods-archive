...
//morph4u show minqr
	...
	static	bool	ShowMinQR()		{return m_bShowMinQR;}
	static	void	SetShowMinQR(bool bo)		{m_bShowMinQR=bo;}
//morph4u show minqr
// ==> CPU/MEM usage [$ick$/Stulle] - Max 
      static    bool    m_ShowCpu;
	  static	bool	GetShowCpu()						{ return m_ShowCpu; }
	  static	void	SetShowCpu(bool bo)			{m_ShowCpu = bo;}
// <== CPU/MEM usage [$ick$/Stulle] - Max 
	//EastShare - added by AndCycle, IP to Country
...
//morph4u server-auto-disconnect +
    static  int     DisconnectTime; 
    static  int     GetDisconnectTime()					{return DisconnectTime; } 
	static  void    SetDisconnectTime(int DisconnectTimeVal) { DisconnectTime = DisconnectTimeVal; } 
...
private:
	static	bool	m_bDropBlockers;
public:
	static	bool	IsDropBlockers()					{return m_bDropBlockers;}
	static	void	SetDropBlockers(const bool& in)		{m_bDropBlockers = in;}
