				...
				if (pLink->GetKind() == CED2KLink::kFile)
				{
					...
					*/
					...
					if (!askIfAlreadyDownloaded 
			            || knownfiles->CheckAlreadyDownloadedFileQuestion(pLink->GetFileLink()->GetHashKey(), pLink->GetFileLink()->GetName()) )
  					//Xman end
#endif
...
void CemuleApp::SearchClipboard()
{
	...
	if (_tcsnicmp(pszTrimmedLinks, _T("ed2k://|file|"), 13) == 0)
	{
		...
		*/
		//Xman [MoNKi: -Check already downloaded files-] //morph4u todo
#ifndef CHECK_ALREADY
