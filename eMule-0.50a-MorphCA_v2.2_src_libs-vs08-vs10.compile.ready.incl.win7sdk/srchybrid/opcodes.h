...
#define	MIN_UP_CLIENTS_ALLOWED	0			//morph4u 3->0 ZZUL // min. clients per class allowed to download regardless UPLOAD_CLIENT_DATARATE or any other factors. Don't set this too high
...
#define SHAREAZAEMUVERSION		0x3D	// X-Ray :: EmulateOthers
#define	FT_ATLASTREQ			0x81		// X-Ray :: SaveLastRequest
