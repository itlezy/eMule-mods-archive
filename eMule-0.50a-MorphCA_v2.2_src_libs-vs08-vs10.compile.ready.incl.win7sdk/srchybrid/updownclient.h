...
public:
	...
	//MORPH - Added by SiRoB, FunnyNick
	/*
	LPCTSTR			GetUserName() const								{ return m_pszUsername; }
	*/
	LPCTSTR			GetUserName(bool bFN = thePrefs.DisplayFunnyNick()) const;
	//MORPH - Added by SiRoB, FunnyNick
...
private:
	bool	m_bIsBadClient;
public:
	bool	IsBadClient() const		{return m_bIsBadClient;}
//<<< WiZaRd::BadClientFlag
private: 
