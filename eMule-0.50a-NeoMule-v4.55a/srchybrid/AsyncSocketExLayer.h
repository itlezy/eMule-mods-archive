...
protected:
	...
	//Nat layer is a layer without an underlying TCP socket there for it have to do some stuff on its own
	void SetNatLayerState(int nLayerState);
	virtual bool IsNatLayer() {return false;}
