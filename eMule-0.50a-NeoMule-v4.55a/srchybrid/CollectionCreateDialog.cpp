...
BEGIN_MESSAGE_MAP(CCollectionCreateDialog, CModResizableDialog) // NEO: MLD - [ModelesDialogs] <-- Xanatos --
	...
	ON_WM_DESTROY() // NEO: MLD - [ModelesDialogs] <-- Xanatos --
...
// NEO: MLD - [ModelesDialogs] -- Xanatos -->
void CCollectionCreateDialog::OnDestroy()
{
	m_CollectionAvailListCtrl.DetachControl();
	m_CollectionListCtrl.DetachControl();
}
// NEO: MLD END <-- Xanatos --