...
//// CDeadSourceList
class CUpDownClient;
class CPartFile; // NEO: SDT - [SourcesDropTweaks] <-- Xanatos --
...
public:
	...
	void		AddDeadSource(const CUpDownClient* pToAdd, bool bDrop = false); // NEO: SDT - [SourcesDropTweaks] <-- Xanatos --
	...
	void		Init(CPartFile* Owner = NULL); // NEO: SDT - [SourcesDropTweaks] <-- Xanatos --
...
private:
	...
	//bool	m_bGlobalList;
	CPartFile*	m_Owner; // NEO: SDT - [SourcesDropTweaks] <-- Xanatos --
};
