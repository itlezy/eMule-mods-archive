...
#include "neo\gui\requestedfilesctrl.h"
...
BEGIN_MESSAGE_MAP(CFileDetailDialog, CModListViewWalkerPropertySheet) // NEO: MLD - [ModelesDialogs] <-- Xanatos --
	ON_WM_DESTROY()
...
CFileDetailDialog::CFileDetailDialog(const CSimpleArray<CAbstractFile*>* paFiles, UINT uPshInvokePage, CListCtrlItemWalk* pListCtrl) // NEO: NFDD - [NewFileDetailDialog] <-- Xanatos --
