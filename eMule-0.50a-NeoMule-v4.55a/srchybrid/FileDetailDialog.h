...
#include "CommentDialog.h" // NEO: NFDD - [NewFileDetailDialog] <-- Xanatos --

class CSearchFile;

class CFileDetailDialog : public CModListViewWalkerPropertySheet // NEO: MLD - [ModelesDialogs] <-- Xanatos --
{
...
public:
	...
	CFileDetailDialog(const CSimpleArray<CAbstractFile*>* paFiles, UINT uInvokePage = 0, CListCtrlItemWalk* pListCtrl = NULL); // NEO: NFDD - [NewFileDetailDialog] <-- Xanatos --
...
protected:
	...
	CCommentDialog			m_wndFileComments; // NEO: NFDD - [NewFileDetailDialog] <-- Xanatos --
