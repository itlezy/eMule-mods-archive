...
void ModLog(LPCTSTR pszFmt, ...)
{
	va_list argp;
	va_start(argp, pszFmt);
	LogV(LOG_MOD, pszFmt, argp);
	va_end(argp);
}

void ModLogError(LPCTSTR pszFmt, ...)
{
	va_list argp;
	va_start(argp, pszFmt);	
	LogV(LOG_MOD | LOG_ERROR, pszFmt, argp);
	va_end(argp);
}

void ModLogWarning(LPCTSTR pszFmt, ...)
{
	va_list argp;
	va_start(argp, pszFmt);	
	LogV(LOG_MOD | LOG_WARNING, pszFmt, argp);
	va_end(argp);
}
...
void ModLog(UINT uFlags, LPCTSTR pszFmt, ...)
{
	va_list argp;
	va_start(argp, pszFmt);
	LogV(uFlags | LOG_MOD, pszFmt, argp);
	va_end(argp);
}

void ModLogError(UINT uFlags, LPCTSTR pszFmt, ...)
{
	va_list argp;
	va_start(argp, pszFmt);	
	LogV(uFlags | LOG_MOD | LOG_ERROR, pszFmt, argp);
	va_end(argp);
}

void ModLogWarning(UINT uFlags, LPCTSTR pszFmt, ...)
{
	va_list argp;
	va_start(argp, pszFmt);	
	LogV(uFlags | LOG_MOD | LOG_WARNING, pszFmt, argp);
	va_end(argp);
}
