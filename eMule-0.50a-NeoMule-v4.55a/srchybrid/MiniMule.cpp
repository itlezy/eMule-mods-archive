	...
	: CDHtmlDialog(CMiniMule::IDD, CMiniMule::IDH, pParent)
{
	...
	m_uWndTransparency = thePrefs.GetMiniMuleTransparency(); // NEO: MOD - [MissingPrefs] <-- Xanatos --
	m_bAutoClose = thePrefs.GetMiniMuleAutoClose(); // NEO: MOD - [MissingPrefs] <-- Xanatos --
