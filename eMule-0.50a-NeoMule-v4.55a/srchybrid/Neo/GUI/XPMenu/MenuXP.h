...
public:
	...
	void	EnableIcons() {}
	void	ChangeMenuIcon(UINT_PTR nIDNewItem, LPCTSTR lpszIconName);
	void	SetMenuBitmap(UINT /*nFlags*/, UINT_PTR nIDNewItem, LPCTSTR /*lpszNewItem*/, LPCTSTR lpszIconName) { ChangeMenuIcon(nIDNewItem,lpszIconName); }
	BOOL	DestroyMenu();
