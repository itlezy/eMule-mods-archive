...
#define	ADD_INTEGER_ITEM(idx, label, group) \
		...
		m_htiServer = m_ctrlTreeOptions.InsertCheckBox(_T("Server"), TVI_ROOT, FALSE, 2); // NEO: FIX - [TreeControl] <-- Xanatos --
		...
		m_htiClient = m_ctrlTreeOptions.InsertCheckBox(_T("Client"), TVI_ROOT, FALSE, 2); // NEO: FIX - [TreeControl] <-- Xanatos --
