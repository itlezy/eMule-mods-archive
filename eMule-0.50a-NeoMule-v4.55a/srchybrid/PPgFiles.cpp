...
void CPPgFiles::LoadSettings(void)
{
	...
	CheckDlgButton(IDC_REMEMBERDOWNLOADED,thePrefs.IsRememberingDownloadedFiles()); // NEO: MOD - [RemoveUnusedAICHhashes] <-- Xanatos --
...
BOOL CPPgFiles::OnApply()
{
	...
	thePrefs.SetRememberDownloadedFiles(IsDlgButtonChecked(IDC_REMEMBERDOWNLOADED)); // NEO: MOD - [RemoveUnusedAICHhashes] <-- Xanatos --
