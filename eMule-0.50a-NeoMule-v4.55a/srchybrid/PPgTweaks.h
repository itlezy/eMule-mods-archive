...
protected:
	//UINT m_iFileBufferSize;  // NEO: MOD - [BufferCustomisation] <-- Xanatos --
	UINT m_iQueueSize;
	...
	//CSliderCtrl m_ctlFileBuffSize; // NEO: MOD - [BufferCustomisation] <-- Xanatos --
	CSliderCtrl m_ctlQueueSize;
    CTreeOptionsCtrl m_ctrlTreeOptions; // NEO: FIX - [TreeControl] <-- Xanatos --
