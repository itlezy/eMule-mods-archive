...
#ifdef VOODOO // NEO: VOODOOs - [VoodooSearchForwarding] -- Xanatos -->
	DDX_Control(pDX, IDC_SEARCH_VOODOO, m_ctlVoodoo);
#endif // VOODOO // NEO: VOODOOs END <-- Xanatos --
}
...
#ifdef VOODOO // NEO: VOODOOs - [VoodooSearchForwarding] -- Xanatos -->
	m_ctlVoodoo.GetWindowRect(&m_rcVoodoo);
	ScreenToClient(&m_rcVoodoo);
	m_ctlVoodoo.EnableWindow(NeoPrefs.UseVoodooSearch());
	//m_ctlVoodoo.ModifyStyle(BS_AUTOCHECKBOX,BS_AUTO3STATE);
#endif // VOODOO // NEO: VOODOOs END <-- Xanatos --
...
#ifdef VOODOO // NEO: VOODOOs - [VoodooSearchForwarding] -- Xanatos -->
		m_ctlVoodoo.MoveWindow(rcClient.left + m_rcVoodoo.left, rcClient.top + m_rcVoodoo.top, m_rcVoodoo.Width(), m_rcVoodoo.Height());
#endif // VOODOO // NEO: VOODOOs END <-- Xanatos --
...
#ifdef VOODOO // NEO: VOODOOs - [VoodooSearchForwarding] -- Xanatos -->
		CRect rcVoodoo;
		m_ctlVoodoo.GetWindowRect(&rcVoodoo);
		ScreenToClient(&rcVoodoo);
		m_ctlVoodoo.MoveWindow(rcClient.left, y, rcClient.Width(), rcVoodoo.Height());
		y += rcVoodoo.Height() + 8;
#endif // VOODOO // NEO: VOODOOs END <-- Xanatos --
...
#ifdef LANCAST // NEO: NLC - [NeoLanCast]
	VERIFY( m_ctlMethod.AddItem(GetResString(IDS_X_LANCAST), 4) == SearchTypeLancast );
#endif //LANCAST // NEO: NLC END
	VERIFY( m_ctlMethod.AddItem(_T("FileDonkey (Web)"), 5) == SearchTypeFileDonkey );
...
#ifdef VOODOO // NEO: VOODOOs - [VoodooSearchForwarding] -- Xanatos -->
	GetDlgItem(IDC_SEARCH_VOODOO)->SetWindowText(GetResString(IDS_X_SEARCH_VOODOO));
#endif // VOODOO // NEO: VOODOOs END <-- Xanatos --
...
{
#ifdef VOODOO // NEO: VOODOOs - [VoodooSearchForwarding] -- Xanatos -->
	if(NeoPrefs.UseVoodooSearch() && m_ctlVoodoo.GetCheck() != FALSE)
