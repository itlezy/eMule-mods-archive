...
BOOL CTrayDialog::TrayShow(bool bStatic) // NEO: STI - [StaticTray] <-- Xanatos --
{
	// NEO: STI - [StaticTray] -- Xanatos -->
	if(!bStatic && NeoPrefs.UseStaticTrayIcon()) 
		return TRUE;
	// NEO: MOD END <-- Xanatos --
...
BOOL CTrayDialog::TrayHide(bool bStatic) // NEO: STI - [StaticTray] <-- Xanatos --
{
	// NEO: STI - [StaticTray]
	if(!bStatic && NeoPrefs.UseStaticTrayIcon()) 
		return TRUE;
	...
	{ 
		...
		case WM_LBUTTONUP:
			...
			else if (m_bLButtonDown)
			{
				...
				{
					//if (!IsWindowVisible())
					if (!IsWindowVisible() || NeoPrefs.UseStaticTrayIcon()) // NEO: STI - [StaticTray] <-- Xanatos --
