...
enum EUserWndMessages
{
	...
	UM_NEO_VERSIONCHECK_RESPONSE, // NEO: NVC - [NeoVersionCheck] <-- Xanatos --
	...
	UM_SPN_SIZED,
	UM_TABMOVED,
//	UM_TREEOPTSCTRL_NOTIFY, // NEO: FIX - [TreeControl] <-- Xanatos --
	UM_DATA_CHANGED,
	UM_OSCOPEPOSITION,
	UM_DELAYED_EVALUATE,
	UM_ARCHIVESCANDONE,

	UM_SIMPLE_CLEANUP_NOTIFY, // NEO: MMR - [MorphMassRemane] <-- Xanatos --
