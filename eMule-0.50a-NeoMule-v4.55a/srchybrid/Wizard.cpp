...
void CConnectionWizardDlg::OnBnClickedApply()
{
	...
	if (upload > 0 && download > 0)
	{
		...
		if (download <= 7)
		{
			...
			{
				case 0:
					NeoPrefs.PartPrefs.SetSourceLimit(100); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
				case 1:
					NeoPrefs.PartPrefs.SetSourceLimit(60); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
				case 2:
					NeoPrefs.PartPrefs.SetSourceLimit(40); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
			}
		}
		else if (download < 62)
		{
			...
			{
				case 0:
					NeoPrefs.PartPrefs.SetSourceLimit(300); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
				case 1:
					NeoPrefs.PartPrefs.SetSourceLimit(200); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
				case 2:
					NeoPrefs.PartPrefs.SetSourceLimit(100); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
		...
		else if (download < 187)
		{
			...
			{
				case 0:
					NeoPrefs.PartPrefs.SetSourceLimit(500); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
				case 1:
					NeoPrefs.PartPrefs.SetSourceLimit(400); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
				case 2:
					NeoPrefs.PartPrefs.SetSourceLimit(350); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
			}
		}
		else if (download <= 312)
		{
			...
			{
				case 0:
					NeoPrefs.PartPrefs.SetSourceLimit(800); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
				case 1:
					NeoPrefs.PartPrefs.SetSourceLimit(600); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
				case 2:
					NeoPrefs.PartPrefs.SetSourceLimit(400); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
		...
		else
		{
			...
			{
				case 0:
					NeoPrefs.PartPrefs.SetSourceLimit(1000); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
				case 1:
					NeoPrefs.PartPrefs.SetSourceLimit(750); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
				case 2:
					NeoPrefs.PartPrefs.SetSourceLimit(500); // NEO: SRT - [SourceRequestTweaks] <-- Xanatos --
					break;
