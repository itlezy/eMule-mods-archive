...
#endif
#define EMULE_GUID_INVMODE		_T("EMULE-{4EADC6FC-516F-4b7c-9066-97D893649570}-INVISIBLEMODE") // NEO: IM - [InvisibelMode] <-- Xanatos --
...
#define CREDIT_CLEANUP_TIME		HR2S(6)		// 6 hour // NEO: XCTA - [XmanExtenedCreditTableArragement] <-- Xanatos --
...
#define OP_NAT_CALLBACKREQUEST	0xA6 /* <target (B) ID 4><requester (A) ID 4> */
#define OP_NAT_CALLBACKREQUESTED_UDP 0xA7	/* <IP of A 4><UDP PORT of A 2><requester (A) ID>(<obf settings 1><UserHash16>) */
#define OP_NAT_CALLBACKREQUESTED 0x37		/* <IP of A 4><UDP PORT of A 2><requester (A) ID>(<obf settings 1><UserHash16>) */ 
...
// clients2.met
#define	CT_UPLOADEDLO			0x01
#define	CT_UPLOADEDHI			0x02
#define	CT_DOWNLOADEDLO			0x03
#define	CT_DOWNLOADEDHI			0x04
#define	CT_LASTSEEN				0x11
#define	CT_SECUREIDENT			0x21
// NEO: SQ - [SaveUploadQueue]
#define	CT_SECUREWAITTIME		0x31
#define	CT_UNSECUREWAITTIME		0x32
// NEO: SQ END
// NEO: NCS - [NeoCreditSystem]
#define	CT_DELTALO				0x41
#define	CT_DELTAHI				0x42
// NEO: NCS END
// NEO: MC END <-- Xanatos --
...
#define  FT_STATUS_EX			 0x80   // NEO: MOD - [FT_STATUS_EX] <-- Xanatos --
...
#define  FT_RELEASE				 0x78	// <uint32>	// NEO: SRS - [SmartReleaseSharing] <-- Xanatos --
...
#define	 FT_STARTUPLOADTIME		 0x57	// <uint32> // NEO: MQ - [MultiQueue] // NEO: SQ - [SaveUploadQueue] <-- Xanatos --
...
#define FT_CATRESUMEORDER		0x7F // NEO: NXC - [NewExtendedCategories] <-- Xanatos --
#define TAG_FILERATING			"\xF7"	// <uint8>
#ifdef VOODOO // NEO: VOODOO - [UniversalPartfileInterface] -- Xanatos -->
#define	FT_VOODOO_FILE			0xFF // Voodoo File without temp file, just the .part.met
...
#ifdef NATTUNNELING // NEO: NATT - [NatTraversal] -- Xanatos -->
#define SRVCAP_NATTRAVERSAL		0x1000
#endif //NATTUNNELING // NEO: NATT END <-- Xanatos --
