...
public:
	...
	void	Process(); // NEO: MOD - [ServerConnect] <-- Xanatos --
	...
	void	AddLowIdRetried()	{m_uLowIDRetrys++;}
	int		GetLowIdRetris()	{return m_uLowIDRetrys;}
	void	ResetLowIdRetried()	{m_uLowIDRetrys = 0;}
	// NEO: RLD END <-- Xanatos --
...
private:
	...
	int		m_uLowIDRetrys; // NEO: RLD - [ReconnectOnLowID] <-- Xanatos --
};