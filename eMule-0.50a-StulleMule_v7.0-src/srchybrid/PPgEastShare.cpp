	...
	, m_ctrlTreeOptions(theApp.m_iDfltImageListColorFlags)
{
	...
	m_htiFineCS = NULL; //EastShare - added by Pretender, modified Fine Credit System
...
void CPPgEastShare::DoDataExchange(CDataExchange* pDX)
{
	...
	if (!m_bInitializedTreeOpts)
	{
		...
		*/
		...
		m_htiFineCS = m_ctrlTreeOptions.InsertCheckBox(GetResString(IDS_FINECS), m_htiCreditSystem, m_bFineCS);//EastShare - added by Pretender, modified Fine Credit System
	...
	*/
	...
	DDV_MinMaxInt(pDX, m_iPayBackFirstLimit, 5, 255); // PBF min and max value - Stulle
	// ==> Pay Back First for insecure clients - Stulle
	DDX_TreeCheck(pDX, IDC_EASTSHARE_OPTS, m_htiIsPayBackFirst2, m_bIsPayBackFirst2);
	DDX_TreeEdit(pDX, IDC_EASTSHARE_OPTS, m_htiPayBackFirstLimit2, m_iPayBackFirstLimit2);
	...
	DDX_TreeCheck(pDX, IDC_EASTSHARE_OPTS, m_htiFineCS, m_bFineCS);//EastShare - added by Pretender, modified Fine Credit System
}
...
BOOL CPPgEastShare::OnApply()
{
	...
	thePrefs.m_bFineCS = m_bFineCS;//EastShare - added by Pretender, modified Fine Credit System
