...
void CPreferences::SavePreferences()
{
	...
	*/
	...
	//EastShare - Added by Pretender, Option for ChunkDots
	//EastShare START - Added by Pretender, modified Fine Credit System
	ini.WriteInt(L"FineCS", m_bFineCS, L"eMule");
	//EastShare END
...
//	resumeSameCat=ini.GetBool(L"ResumeNextFromSameCat",false);
	...
	*/
	...
	// ==> new credit system - Stulle
	/*
	creditSystemMode = ini.GetInt(L"CreditSystemMode", 0); // EastShare - Added by linekin, ES CreditSystem
	...
	*/
	...
	//MORPH END   - Added by SiRoB, SLUGFILLER: lowIdRetry
	//MORPH	Start	- Added by AndCycle, SLUGFILLER: Spreadbars - per file
	m_iSpreadbarSetStatus = ini.GetInt(L"SpreadbarSetStatus", 1); // Stulle
	//MORPH	End	- Added by AndCycle, SLUGFILLER: Spreadbars - per file
	//MORPH START - Added by SiRoB, SLUGFILLER: hideOS
	...
	m_iPowershareMode=ini.GetInt(L"PowershareMode",0); // Stulle
	...
	// EastShare END - Added by TAHO, .met file control
	//EastShare - Added by Pretender, Option for ChunkDots
	m_bEnableChunkDots=ini.GetBool(L"EnableChunkDots",false); // Stulle
	//EastShare - Added by Pretender, Option for ChunkDots
	//EastShare START - Added by Pretender, modified Fine Credit System
	m_bFineCS=ini.GetBool(L"FineCS", false);
	//EastShare END
	...
	*/
	uint32 m_uTemp = ini.GetInt(L"PayBackFirstLimit", 10);
	...
	m_iAdvancedA4AFMode=(uint8)ini.GetInt(L"AdvancedA4AFMode", 2); // Stulle
