// $Id: frame.cpp,v 1.36 2002/09/13 15:37:23 t1mpy Exp $
 ...
 **
 ** @author Dirk Mahoney
 ** @version $Id: frame.cpp,v 1.36 2002/09/13 15:37:23 t1mpy Exp $
 ** @see ID3_Tag
 ** @see ID3_Field
 ** @see ID3_Err
 **/
...
#else
void ID3_Frame::SetCompression(bool b)
{
	_impl->SetCompression(b);
}
#endif
...
#else
void ID3_Frame::SetEncryptionID(uchar id)
{
	_impl->SetEncryptionID(id);
}
#endif
...
#else
void ID3_Frame::SetGroupingID(uchar id)
{
	_impl->SetGroupingID(id);
}
#endif
