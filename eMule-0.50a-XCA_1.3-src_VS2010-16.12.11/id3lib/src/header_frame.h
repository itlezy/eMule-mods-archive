// -*- C++ -*-
// $Id: header_frame.h,v 1.3 2002/09/13 15:37:23 t1mpy Exp $
...
#else
  void SetCompression(bool b) { this->_flags.set(COMPRESSION, b); }
  void SetEncryption(bool b)  { this->_flags.set(ENCRYPTION, b); }
  void SetGrouping(bool b)    { this->_flags.set(GROUPING, b); }
#endif
