// -*- C++ -*-
// $Id: header_tag.h,v 1.3 2002/09/13 15:37:23 t1mpy Exp $
...
public:
...
#else
  void SetUnsync(bool b)
  {
	  _flags.set(HEADER_FLAG_UNSYNC, b);
  }
#endif
  ...
  {
	  _flags.set(HEADER_FLAG_EXTENDED, b);
  }
#endif
  ...
  {
	  _flags.set(HEADER_FLAG_EXPERIMENTAL, b);
  }
#endif
