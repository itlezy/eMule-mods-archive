...
{
	_impl->SetExtended(ext);
}

void ID3_Tag::SetPadding(bool pad)
{
	_impl->SetPadding(pad);
}

void ID3_Tag::SetExperimental(bool exp)
{
	_impl->SetExperimental(exp);
}
#endif
