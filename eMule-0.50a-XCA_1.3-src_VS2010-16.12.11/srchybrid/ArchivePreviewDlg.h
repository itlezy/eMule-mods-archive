...
protected:
	...
	sint_ptr ShowISOResults(sint_ptr ret, archiveScannerThreadParams_s* tp);
	sint_ptr ShowZipResults(sint_ptr ret, archiveScannerThreadParams_s* tp);
	sint_ptr ShowRarResults(sint_ptr ret, archiveScannerThreadParams_s* tp);
	sint_ptr ShowAceResults(sint_ptr ret, archiveScannerThreadParams_s* tp);
