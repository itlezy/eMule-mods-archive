...
public:
	...
	*/
	typedef enum { kServerList, kServer , kFile , kNodesList, kSearch, kFriend, kInvalid } LinkType;
...
{
public:
	CED2KFileLink(const TCHAR* pszName, const TCHAR* pszSize, const TCHAR* pszHash, const CAtlArray<CString>& param, const TCHAR* pszSources);
	...
	CAtlList<SUnresolvedHostname*> m_HostnameSourcesList;
...
public:
	...
	void	GetUserHash(uchar userHash[]) const		{ md4cpy(userHash, m_hash); }
