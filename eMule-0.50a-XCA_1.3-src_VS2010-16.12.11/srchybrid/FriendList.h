...
public:
	...
	bool		AddFriend(const uchar* abyUserhash, uint64 dwLastSeen, uint32 dwLastUsedIP, uint16 nLastUsedPort, 
	...
	void		Process();
	size_t		GetCount()		{ return m_listFriends.GetCount(); }

private:
	CAtlList<CFriend*>	m_listFriends;
