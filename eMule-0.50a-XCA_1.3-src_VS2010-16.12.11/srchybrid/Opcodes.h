...
#define KADEMLIA_VERSION6_48b			0x06 //0.48b
...
#define I64TIMEMASK						0x80
#define I64TIMEMASKPART					0x8
#define LOADINDEX_VERSION	0x01
#define KEYINDEX_VERSION	0x04
#define SRCINDEX_VERSION	0x02
...
#define	MIN_UP_CLIENTS_ALLOWED	0    //morph4u 2->0			// min. clients allowed to download regardless UPLOAD_CLIENT_DATARATE or any other factors. Don't set this too high
...
//Xman Xtreme Downloadmanager changed from 15 to 40, important!
...
#define MINWAIT_BEFORE_DLDISPLAY_WINDOWUPDATE   1500// X changed from 1000
...
#define  FT_KADLASTPUBLISHSRC	 0x21	// <uint64>
...
#define  FT_KADLASTPUBLISHNOTES	 0x26	// <uint64> 
...
#define TIMER_PERIOD			100			// base period in [ms] (emule default is 100 [ms])
#endif
#define DISPLAY_REFRESH			2			// GUI refresh rate in [s] (emule default is 3 [s])// X changed from 1
#define DISPLAY_REFRESH_CLIENTLIST			2*DISPLAY_REFRESH //GUI clientlist refresh
