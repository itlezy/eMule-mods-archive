...
void CSearchDlg::SetSelectedCat(int iSel)
{
	m_pwndResults->SetSelectedCat(iSel);
}
...
{
	m_pwndResults->SearchCanceled(uSearchID);
}
...
void CSearchDlg::Localize()// X: [RUL] - [Remove Useless Localize]
{
	m_pwndResults->LocalizeAll();
	m_pwndParams->LocalizeAll();
}
...
void CSearchDlg::SearchRelatedFiles(CAtlList<CAbstractFile*>& listFiles)
{
