...
void CSharedDirsTreeCtrl::SetAllIcons()
{
	...
	if (pCurImageList != NULL && pCurImageList->GetImageCount() >= 7)
	{
		...
		CString strTempDir(thePrefs.GetMuleDirectory(EMULE_CONFIGDIR/*EMULE_INCOMINGDIR*/));// X: [BF] - [Bug Fix]
...
void CSharedDirsTreeCtrl::ShowFileDialog(CAtlList<CShareableFile*>& aFiles, UINT uPshInvokePage)
{
