...
#define _tcsdup(p)		  _tcsdup_dbg(p, _NORMAL_BLOCK, __FILE__, __LINE__)
#endif
#endif

typedef CAtlArray<CStringA> CStringAArray;
typedef CAtlArray<CStringW> CStringWArray;
...
#endif
#define _CString(T) CString(T, _countof(T)-1)