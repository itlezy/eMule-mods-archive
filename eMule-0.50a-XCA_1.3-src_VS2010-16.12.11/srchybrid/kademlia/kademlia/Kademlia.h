...
namespace Kademlia
{
	...
	class CKademlia
	{
		public:
			...
			static uint_ptr GetKademliaUsers(bool bNewMethod = false);
			static uint_ptr GetKademliaFiles();
		...
		private:
			static uint_ptr CalculateKadUsersNew();
			...
			static CAtlList<uint32> m_liStatsEstUsersProbes;
