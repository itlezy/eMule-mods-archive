...
namespace Kademlia
{
	...
	private:
		...
		static unordered_map<uint32, uint32> s_mapGlobalContactIPs;
		static unordered_map<uint32, uint32> s_mapGlobalContactSubnets;
#else
		static CAtlMap<uint32, uint32> s_mapGlobalContactIPs;
		static CAtlMap<uint32, uint32> s_mapGlobalContactSubnets;
#endif
	};
}
