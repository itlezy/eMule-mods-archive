...
public:
	...
	*/
	...
	static bool GetRememberAICH() {return m_rememberAICH && IsRememberingDownloadedFiles();}
	...
	static void	SetMaxUpload(float in)	{maxupload = in; CheckSlotSpeed();/*zz_fly :: check slotspeed when maxupload changed*/}
	...
	static bool		IsKnown2SplitEnabled()	{return m_bKnown2Split && GetRememberAICH();} //this feature only available when user want to remember unused AichHashSet.
	...
	*/
	...
	static void		SetPushSmallFileSize(int size) {m_iPushSmallFiles = (uint32)((size > 0 && size <= 2*1024*1024 /*2M*/) ? size : 262144 /*256k*/);}
	static uint16	GetPushSmallFileBoost()		{return m_iPushSmallBoost;}
	static void		SetPushSmallFileBoost(int temp) {m_iPushSmallBoost = (uint16)((temp > 0 && temp <= 10000) ? temp : 50);}
