...
{
	//zz_fly :: fix minimize to tray issue :: Enig123 :: start
	/*
	return m_bTrayIconVisible;
	*/	
	BOOL bTrayIconVisible;
	tray_Locker.Lock();
	bTrayIconVisible = m_bTrayIconVisible;
	tray_Locker.Unlock();
	return bTrayIconVisible;
	//zz_fly :: fix minimize to tray issue :: Enig123 :: end
}
...
{
	BOOL bSuccess = FALSE;
	tray_Locker.Lock();	//zz_fly :: fix minimize to tray issue :: Enig123
	...
	tray_Locker.Unlock();	//zz_fly :: fix minimize to tray issue :: Enig123
	return bSuccess;
}
