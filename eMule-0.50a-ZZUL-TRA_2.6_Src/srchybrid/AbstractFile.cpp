	...
	: m_FileIdentifier(m_nFileSize)
{
	...
	m_bCompressible = false; // ZZUL-TRA :: CompressionChoosing
}
	...
	: m_FileIdentifier(pAbstractFile->m_FileIdentifier, m_nFileSize)
{
	...
	m_bCompressible = pAbstractFile->IsCompressible(); // ZZUL-TRA :: CompressionChoosing
...
{ 
	...
	// ZZUL-TRA :: CompressionChoosing :: Start
	// Check extension
	m_bCompressible = true;
	...
	// ZZUL-TRA :: CompressionChoosing :: End
} 
