...
enum EClientSoftware{
	...
	SO_EMULEPLUS		= 5,	// ZZUL-TRA :: EnhancedClientRecognization
	SO_HYDRANODE		= 6,	// ZZUL-TRA :: EnhancedClientRecognization
	SO_EASYMULE2		= 8,	// ZZUL-TRA :: EnhancedClientRecognization
	SO_MLDONKEY			= 10,	// ET_COMPATIBLECLIENT
	SO_LPHANT			= 20,	// ET_COMPATIBLECLIENT
	SO_SHAREAZA2		= 28,	// ZZUL-TRA :: EnhancedClientRecognization
	SO_TRUSTYFILES		= 30,	// ZZUL-TRA :: EnhancedClientRecognization
	SO_SHAREAZA3		= 40,	// ZZUL-TRA :: EnhancedClientRecognization
	// other client types which are not identified with ET_COMPATIBLECLIENT
	SO_EDONKEYHYBRID	= 50,
	SO_EDONKEY			= 51,	// ZZUL-TRA :: EnhancedClientRecognization
	SO_MLDONKEY2		= 52,	// ZZUL-TRA :: EnhancedClientRecognization
	SO_OLDEMULE			= 53,	// ZZUL-TRA :: EnhancedClientRecognization
	SO_SHAREAZA4		= 68,	// ZZUL-TRA :: EnhancedClientRecognization
	SO_MLDONKEY3		= 152,	// ZZUL-TRA :: EnhancedClientRecognization
	SO_URL,
	SO_UNKNOWN
};
...
enum ESourceFrom{
	...
	SF_PASSIVE			= 3,
	SF_LINK				= 4,
	SF_SLS				= 5,	// ZZUL-TRA :: SLS
	SF_CACHE			= 6	// ZZUL-TRA :: Sourcecache
};
