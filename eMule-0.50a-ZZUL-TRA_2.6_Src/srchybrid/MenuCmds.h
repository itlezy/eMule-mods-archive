...
#define MP_PS_AMOUNT_LIMIT      10157
#define MP_PS_AMOUNT_LIMIT_SET  10158
...
#define MP_SLOTFOCUS                                    10405
#define	MP_HM_TOGGLESPEEDGRAPH	                	10406// X: [SGW] - [SpeedGraphWnd]

// <CB Mod : Friend Management : Date 11.07.07>
#ifdef CB_MOD_EASYFRIENDSLOT_ENABLED
#define MP_REMFRIENDSLOT        10407
#define MP_ADDFRIENDSLOT        10408
#endif
// <CB Mod : Friend Management>

//MORPH START - Added, Downloaded History [Monki/Xman]
#define MP_VIEWSHAREDFILES			10409
#define MP_CLEARHISTORY				10410
#define MP_MERGEHISTORY				10411
//MORPH END   - Added, Downloaded History [Monki/Xman]

#define MP_HM_OPENLOG                           10412//open log
// ZZUL-TRA :: Feedback :: Start
#define MP_FILEFEEDBACK			10422
#define MP_FILEFEEDBACK_BB		15009
// ZZUL-TRA :: Feedback :: End

#define MP_AUTODISCONNECT                10424
#define	MP_HM_QUICKSTART		    10425 // NEO: QS - [QuickStart] <-- Xanatos --
#define	MP_HM_REMOVEALLBANNEDCLIENTS	10426
#define MP_LOGFRIENDS		10442
// MORPH START - Added by Commander, Friendlinks [emulEspaa] - added by zz_fly
#define MP_GETFRIENDED2KLINK		10444
#define MP_GETMYFRIENDED2KLINK		10445
// MORPH END - Added by Commander, Friendlinks [emulEspaa]

// ZZUL-TRA :: ULPrioExtension :: Start
#define MP_PRIOUPVERYLOW		10446
#define MP_PRIOUPLOW			10447
#define MP_PRIOUPNORMAL			10448
#define MP_PRIOUPHIGH			10449
#define MP_PRIOUPVERYHIGH		10450
#define MP_PRIOUPAUTO			10451
// ZZUL-TRA :: ULPrioExtension :: End

// ZZUL-TRA :: PSExtension :: Start
#define MP_POWERSHAREUP_DEFAULT	  20034
#define MP_POWERSHAREUP_OFF       20035
#define MP_POWERSHAREUP_ON        20036
#define MP_POWERSHAREUP_AUTO      20037
#define MP_POWERSHAREUP_LIMITED   20038
#define MP_POWERSHARE_LIMIT_UP     20039
#define MP_POWERSHARE_LIMIT_SET_UP 20040
#define MP_PS_AMOUNT_LIMIT_UP      20041
#define MP_PS_AMOUNT_LIMIT_SET_UP  20042
// ZZUL-TRA :: PSExtension :: End

#define	MP_IMPORT				10461
