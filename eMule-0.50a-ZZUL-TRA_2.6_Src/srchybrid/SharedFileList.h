...
public:
	...
	bool	AddSingleSharedFile(const CString& rstrFilePath, bool bNoUpdate, int &iDoAsfuReset); // includes updating sharing preferences, calls CheckAndAddSingleSharedFile afterwards // ZZUL-TRA :: AutoSharedFilesUpdater
	...
	void	UpdatePartsInfo(); //ZZUL-TRA :: PowerShare
...
public:	// ZZUL-TRA :: AutoSharedFilesUpdater
	CStringList			m_liSingleSharedFiles;
private:	// ZZUL-TRA :: AutoSharedFilesUpdater
