...
public:
	...
	enum TBBIDS {
		...
		//TBB_DISCONNECT, //morph4u changed thumbbar button
		TBB_THROTTLE,
		TBB_UNTHROTTLE,
		TBB_PREFERENCES,
	...
	void RestartMuleApp(); // ZZUL-TRA :: AutoRestartIfNecessary
...
protected:
	...
	//void ShowToolPopup(bool toolsonly = false);// X: [SGW] - [SpeedGraphWnd] move up
	void SetAllIcons();
