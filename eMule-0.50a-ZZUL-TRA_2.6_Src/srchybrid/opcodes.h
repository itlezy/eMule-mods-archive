...
#define SESSIONMAXTIME			HR2MS(4)	//1 hour //morph4u changed
...
#define	UPLOAD_CHECK_CLIENT_DR	(1024*0.7*thePrefs.GetClientDataRate())
#define UPLOAD_CLIENT_DATARATE	(1024*thePrefs.GetClientDataRate())
...
#define CLIENTBANTIME			HR2MS(thePrefs.GetClientbantime())	// Spike2 - variable Client Bantime
...
#define SHAREAZAEMUVERSION		0x3D	// ZZUL-TRA :: EmulateOthers

// ZZUL-TRA :: Global Hardlimit :: Start
#define FT_GLOBALHL			"GLOBAL_HL" 
#define	VAL_GSL_MIN			1000
#define	VAL_GSL_DEF			4000
#define VAL_GSL_MAX			9999
