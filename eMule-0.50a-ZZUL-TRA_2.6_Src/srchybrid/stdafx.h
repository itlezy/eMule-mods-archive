...
//>>> EasyPreprocessor (WiZaRd) +
#define CLIENTANALYZER
#define CB_MOD_EASYFRIENDSLOT_ENABLED //CB Mod : Friend Management
#define EVENLINE
#define ATWL // Advanced Transfer Window Layout - Stulle
//#define CHUNK_DOTS //SLUGFILLER: chunkDots
//#define HIGHRES //High Speed Upload Timer
//<<< EasyPreprocessor (WiZaRd) -
...
*/
#include "Addons/Winsock2/afxsock.h" // MFC-Socket-Erweiterungen 
