...
#include "CollectionListCtrl.h"	// Tux: Feature: Modeless dialogs
	...
	: m_FileIdentifier(m_nFileSize)
{
	...
	m_detailSheetInterface = new CCollectionFileDetailsSheetInterface(this);	// Tux: Feature: Modeless dialogs
}
...
CAbstractFile::~CAbstractFile()
{
	delete m_detailSheetInterface;	// Tux: Feature: Modeless dialogs
	ClearTags();
