...
class CTag;
class CCollectionFileDetailsSheetInterface;	// Tux: Feature: Modeless dialogs
...
public:
	...
	bool	HasBadRating()	const { return (m_uUserRating == 1); }	// Tux: Improvement: Code improvement
	...
	CCollectionFileDetailsSheetInterface*	GetDetailSheetInterface() const { return m_detailSheetInterface; }	// Tux: Feature: Modeless dialogs
...
protected:
	...
	CCollectionFileDetailsSheetInterface*	m_detailSheetInterface;	// Tux: Feature: Modeless dialogs
};
