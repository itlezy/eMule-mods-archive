...
// Tux: Feature: Modeless dialogs [start]: changed lines
IMPLEMENT_DYNAMIC(CAddFriend, CModelessDialog)

BEGIN_MESSAGE_MAP(CAddFriend, CModelessDialog)
// Tux: Feature: Modeless dialogs [end]
	ON_BN_CLICKED(IDC_ADD, OnAddBtn)
END_MESSAGE_MAP()

CAddFriend::CAddFriend()
	: CModelessDialog(CAddFriend::IDD)	// Tux: Feature: Modeless dialogs: changed line
{
	m_pShowFriend = NULL;
	m_icnWnd = NULL;
}
...
{
	CModelessDialog::DoDataExchange(pDX);	// Tux: Feature: Modeless dialogs: changed line
}

BOOL CAddFriend::OnInitDialog()
{
	CModelessDialog::OnInitDialog();	// Tux: Feature: Modeless dialogs: changed line
