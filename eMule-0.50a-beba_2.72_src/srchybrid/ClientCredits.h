...
//struct CreditStruct{
struct CreditStruct_30c{	// Tux: Feature: SUQWT
	uchar		abyKey[16];
	uint32		nUploadedLo;	// uploaded TO him
	uint32		nDownloadedLo;	// downloaded from him
	uint32		nLastSeen;
...
#pragma pack()
typedef CreditStruct_30c_SUQWTv2    CreditStruct;	// Tux: Feature: SUQWT
...
public:
	...
	void	SetLastSeen()					{m_pCredits->nLastSeen = (uint32)time(NULL);} // Tux: others: C4244 fix
