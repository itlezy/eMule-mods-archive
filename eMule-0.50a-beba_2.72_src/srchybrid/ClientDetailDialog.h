...
#include "Modeless.h"	// Tux: Feature: Modeless dialogs: removed other includes :)
...
class CClientDetailDialog : public CModelessPropertySheet	// Tux: Feature: Modeless dialogs: changed line
{
...
public:
	...
	void	OpenDetailDialog(CListCtrlItemWalk* pListCtrl = NULL);
	void	OpenDetailDialog(const CSimpleArray<CUpDownClient*>* paClients, CListCtrlItemWalk* pListCtrl = NULL);
