...
enum EClientSoftware{
	...
	SO_SHAREAZA2		= 28,	// Tux: Feature: Emulate Shareaza - why do some 'raza-Mods send this ID ??
	// other client types which are not identified with ET_COMPATIBLECLIENT
	SO_TRUSTYFILES		= 30,	// Tux: Feature: Enhanced Client Recognition v2
	SO_SHAREAZA3		= 40,	// Tux: Feature: Emulate Shareaza - some 'azas, mostly Betas, send this
	SO_EDONKEYHYBRID	= 50,
	// Tux: Feature: Enhanced Client Recognition v2 [start]
	// -> changed and added values
	SO_EDONKEY			= 51,
	SO_MLDONKEY2		= 52,
	SO_OLDEMULE			= 53,
	SO_SHAREAZA4		= 68,
...
enum ESourceFrom{
	...
	SF_PASSIVE			= 3,
	SF_LINK				= 4,
	SF_SEARCH			= 5,	// Tux: Feature: searchCatch
	SF_SLS				= 6		// Tux: Feature: SLS
};
