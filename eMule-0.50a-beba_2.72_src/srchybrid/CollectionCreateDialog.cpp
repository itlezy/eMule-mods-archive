...
BEGIN_MESSAGE_MAP(CCollectionCreateDialog, CModelessResizableDialog)
...
CCollectionCreateDialog::CCollectionCreateDialog(CWnd* pParent /*=NULL*/)
	...
	: CModelessResizableDialog(CCollectionCreateDialog::IDD, pParent)
	// Tux: Feature: Modeless dialogs [end]
	, m_pCollection(NULL)
...
BOOL CCollectionCreateDialog::OnInitDialog(void)
{
	...
	CModelessResizableDialog::OnInitDialog();
	// Tux: Feature: Modeless dialogs [end]
