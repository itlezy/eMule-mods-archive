...
class CCollectionFileDetailsSheetInterface : public CModelessPropertySheetInterface
{
public:
	CCollectionFileDetailsSheetInterface(CAbstractFile* owner);
	void	OpenDetailSheet(CTypedPtrList<CPtrList, CAbstractFile*>& aFiles, UINT uPshInvokePage = 0, CListCtrlItemWalk* pListCtrl = NULL);
