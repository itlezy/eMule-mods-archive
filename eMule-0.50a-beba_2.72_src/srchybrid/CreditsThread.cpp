...
// Tux: others: beba credits [start]
	m_arCredits.Add(_T("01:08:eMule beba - modified by Tuxman"));
	m_arCredits.Add(_T("S:5"));
	m_arCredits.Add(_T("01:08:See changelog for beba's contributors!"));
	m_arCredits.Add(_T("S:50"));
// Tux: others: beba credits [end]
