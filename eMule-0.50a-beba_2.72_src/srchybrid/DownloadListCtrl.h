...
class CDownloadListCtrl : public CMuleListCtrl, public CDownloadListListCtrlItemWalk
{
	...
	friend class CDownloadClientsCtrl;	// Tux: Improvement: Arabella Tweak
...
public:
	...
	void	DropAllFullQ(); //LSD
	void	DropAllNNS(); //LSD
	void	DropAllTooMany(); //LSD
	void	DropUnknown(); //LSD
	// Tux: Feature: Drop buttons [end]
	
	void    StopSingleClient (CUpDownClient* single);	// Tux: Feature: Stop this client
...
protected:
	...
	CTitleMenu	m_DropMenu;	// Tux: Feature: Drop Menu
	CTitleMenu	m_SourcesMenu;	// Tux: Feature: Auto Hard Limit: added "Title"
	bool		m_bRemainSort;
