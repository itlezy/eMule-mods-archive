...
public:
	POSITION	GetFileHeadPosition() {return filelist.GetHeadPosition();}
	CPartFile*	GetNextFile(POSITION& pos) {return filelist.GetNext(pos);}
...
public:
	void SetCatRelativePriorities(UINT nCat = 0);
	void SetRelativePriorities(CTypedPtrList<CPtrList, CPartFile*>* pFileList = NULL);
protected:
	uint32 m_dwLastRelativePrioTime;
