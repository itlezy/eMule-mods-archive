...
class CCollection;
class CAICHHashAlgo;
class CSharedFileDetailsSheetInterface;	// Tux: Feature: Modeless dialogs
...
public:
	...
	// preview
	bool	IsMovie() const;
	bool	IsMusic() const;	// Tux: Improvement: Preview music files - by IceCream
	...
	static bool	CreateHash(const uchar* pucData, uint32 uSize, uchar* pucHash, CAICHHashTree* pShaHashOut = NULL, bool slowdown=false);	// Tux: Feature: Nice Hash: added boolean value
...
private:
	uint16 onuploadqueue;	// Tux: Feature: see OnUploadqueue
