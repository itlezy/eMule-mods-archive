...
//#define MP_SEARCHRELATED		10350 // Tux: LiteMule: remove Search Related Files
...
#define MP_CLEARBANS			15000	// Tux: Feature: Clear Ban List
#define MP_FILENAME				15001	// Tux: Feature: Filename Disparity Check
#define MP_SLOTFOCUS			15002	// Tux: Feature: Slot Focus
#define MP_DROP_FULLQR			15003	// Tux: Feature: Drop sources
#define MP_DROP_NNS				15004	// Tux: Feature: Drop sources
#define MP_DROP_MANY			15005	// Tux: Feature: Drop sources
#define MP_DROP_UNKNOWN			15006	// Tux: Feature: Drop sources
#define MP_DROP_ALL_FRIENDSLOTS	15007	// Tux: Feature: Remove all friend slots
#define MP_LIST_REQUESTED_FILES	15008	// Tux: Feature: List all requested files
#define MP_AUTOHL_ON			15009	// Tux: Feature: Auto Hard Limit
#define MP_AUTOHL_OFF			15010	// Tux: Feature: Auto Hard Limit
#define MP_STOP_CLIENT			15011	// Tux: Feature: Stop this client
#define MP_PRIORELATIVE			15012	// Tux: Feature: Relative Priority

#define MP_BEBA_BOARD			16000	// Tux: others: added beba links
#define MP_BEBA_WEBSITE			16001	// Tux: others: added beba links
#define MP_BEBA_BOARD_IT		16002	// Tux: others: added beba links
#define MP_BEBA_VCHECK			16003	// Tux: others: added beba links