...
#pragma once
//#include "LayeredWindowHelperST.h"	// Tux: Improvement: no need for external files :-)
...
protected:
	...
	//CLayeredWindowHelperST m_layeredWnd;	// Tux: Improvement: no need for external files :-)
