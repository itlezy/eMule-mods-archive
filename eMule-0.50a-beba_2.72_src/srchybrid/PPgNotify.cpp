...
BOOL CPPgNotify::OnInitDialog()
{
	...
	ASSERT( IDC_CB_TBN_NOSOUND < IDC_CB_TBN_USESOUND );	// Tux: LiteMule: Remove TTS: changed
	CheckRadioButton(IDC_CB_TBN_NOSOUND, IDC_CB_TBN_USESOUND, iBtnID);	// Tux: LiteMule: Remove TTS: changed
	...
	// Tux: LiteMule: Remove Sendmail: removed code block
...
// Tux: LiteMule: Remove TTS: removed code block
