...
#pragma once
#include "opcodes.h"	// Tux: Feature: Relative Priority

const CString strDefaultToolbar = _T("009901020304050607089909");	// Tux: LiteMule: changed
...
enum ENotifierSoundType{
	ntfstNoSound = 0,
	ntfstSoundFile = 1
	// Tux: LiteMule: Remove TTS: removed line
};
...
public:
	...
	// Tux: Feature: Disable server deletion [start]
	static	bool	m_bDeleteDeadServers;
	static	bool	IsDeadServersEnabled()	{return m_bDeleteDeadServers;}
	// Tux: Feature: Disable server deletion [end]
	...
	// static	bool	m_bSafeServerConnect;	// Tux: Newbie security: remove SafeServerConnect
	...
	static	bool	m_bLogSUQWT;	// Tux: Feature: SUQWT
	static	bool	m_bLogKadSecurityEvents;	// Tux: Improvement: log Kad security events
	static	bool	m_bLogAICHEvents;	// Tux: Improvement: log AICH events
	static	bool	m_bLogSLSEvents;	// Tux: Improvement: log SLS events
	static	bool	m_bLogCryptEvents;	// Tux: Improvement: log CryptLayer events
	static	bool	m_bLogAnalyzerEvents;	// Tux: Feature: Client Analyzer
...
// Tux: Improvement: remove debug overhead [end]
	...
	// static	bool	m_btransferfullchunks;	// Tux: Newbie security: remove TransferFullChunks
	...
	// static	bool	m_bCreditSystem;	// Tux: Newbie security: remove UseCreditSystem
	...
	//static  bool	m_bShowWin7TaskbarGoodies; // Tux: LiteMule: Win7 addons always enabled
	...
	//static  bool	m_bUseOldTimeRemaining;	// Tux: LiteMule: Remove advanced calculation method checkbox
...
private:
	static	bool	m_bNamecheckenabled;
	static	bool	m_bPaintFDCRed;
public:
	static	bool	GetNamecheckenabled() {return m_bNamecheckenabled;}
	static	int		GetPaintFDCRed() {return (m_bPaintFDCRed ? 1 : 0);}
	static  int     FDCSensitivity;
...
public:
	...
	static	int		IsUseAutoHL()				{return m_bUseAutoHL;}
	static	void	SetUseAutoHL(const int& i)	{m_bUseAutoHL = i;}
...
public:
	...
	static	void	SetSaveLoadSource(const bool& in)		{m_bUseSaveLoadSources = in;}
	static	uint8	GetActivationLimitSLS()					{return m_iActivationLimitSLS;}
	static	void	SetActivationLimitSLS(const uint8& in)	{m_iActivationLimitSLS = in;}
	static	uint8	GetSourcesToSaveSLS()					{return m_iSourcesToSaveSLS;}
	static	void	SetSourcesToSaveSLS(const uint8& in)	{m_iSourcesToSaveSLS = in;}
	// Tux: Feature: SLS [end]

	// Tux: Feature: Slot Control [start]
private:
	static	uint32	m_uUpDataratePerClient;
	static	bool	m_bOpenMoreSlots;
public:
	static	uint32	GetUpSlots()	{return m_uUpDataratePerClient;}
	static	bool	GetOpenMoreSlots()	{return m_bOpenMoreSlots;}
	static	void	SetUpSlots(const uint32& in)	{m_uUpDataratePerClient = in;}
	static	void	SetOpenMoreSlots(const bool& in)	{m_bOpenMoreSlots = in;}
	// Tux: Feature: Slot Control [end]

	// Tux: Feature: Probabilistic Queue [start]
private:
	static	bool	m_bRandQueue;
public:
	static	bool	GetRandQueue()		{return m_bRandQueue;}
	// Tux: Feature: Probabilistic Queue [end]

	// Tux: Feature: Infinite Queue [start]
private:
	static	bool	infiniteQueue;
public:
	static	bool	IsInfiniteQueueEnabled()	{return infiniteQueue;}
	// Tux: Feature: Infinite Queue [start]
	
	// Tux: Feature: Release Bonus [start]
private:
	static	bool	m_bReleaseBonusEnabled;
	static	int		m_iReleaseBonusFactor;
public:
	static	bool	IsReleaseBonus()	{return m_bReleaseBonusEnabled;}
	static	int		GetReleaseBonus()	{return m_iReleaseBonusFactor;}
	// Tux: Feature: Release Bonus [end]
	
	// Tux: Feature: Slot Focus [start]
private:
	static	bool	SlotFocus;
public:
	static	bool	IsSlotFocusDisabled()		{return SlotFocus;}
	static	void	SetSlotFocus(const bool& in)	{SlotFocus=in;}
	// Tux: Feature: Slot Focus [end]

	// Tux: Feature: Snarl notifications [start]
private:
	static	bool	m_bSnarlDisabled;
public:
	static	bool	IsSnarlDisabled()		{return m_bSnarlDisabled;}
	static	void	SetSnarlDisabled(const bool& in)	{m_bSnarlDisabled=in;}
	// Tux: Feature: Slot Focus [end]
...
private:
	static	bool	m_bReaskSrcAfterIPChange;
	static	uint32	m_uReaskTimeDif;
public:
	static	bool	GetReaskSrcAfterIPChange()	{return m_bReaskSrcAfterIPChange;}
...
private:
	static	uint16	m_iRelativePrioAutoTime;
	static	bool	m_bRelativePrioAutoSet;
public:
	static	uint16	GetRelativePrioAutoTimeP()	{return m_iRelativePrioAutoTime;}
	static	bool	GetRelativePrioAutoSet()	{return m_bRelativePrioAutoSet;}
	static	const bool     IsAutoRelativePrioEnabled()	{return (m_iRelativePrioAutoTime != 0 && m_iRelativePrioAutoTime > 9 && m_bRelativePrioAutoSet);}
	static	const uint32   GetRelativePrioAutoTime()	{return (IsAutoRelativePrioEnabled() ? MIN2MS(m_iRelativePrioAutoTime) : (uint32)-1);}
	// Tux: Feature: Relative Priority [end]
	
	// Tux: Feature: TITS :D [start]
private:
	static	bool	m_bEasterEgg;
public:
	static	bool	GetEasterEgg()	{return m_bEasterEgg;}
	// Tux: Feature: TITS :D [end]
...
public:
	...
	static	void	SetDirectoryWatcher(const bool b)	{ m_bDirectoryWatcher = b; }
	...
	// Tux: LiteMule: Remove Scheduler
	friend class CPPgBeba;	// Tux: others: beba prefs
	...
	//static	UINT	GetToolTipDelay(void)				{return m_iToolDelayTime;}	// Tux: LiteMule: Remove Tooltip Delay
	...
	// static	bool	TransferFullChunks()				{return m_btransferfullchunks;}	// Tux: Newbie security: remove TransferFullChunks
	// static	void	SetTransferFullChunks( bool m_bintransferfullchunks )				{m_btransferfullchunks = m_bintransferfullchunks;}	// Tux: Newbie security: remove TransferFullChunks
	...
	// static	bool	UseCreditSystem()					{return m_bCreditSystem;}	// Tux: Newbie security: remove UseCreditSystem
	// static	void	SetCreditSystem(bool m_bInCreditSystem) {m_bCreditSystem = m_bInCreditSystem;}	// Tux: Feature: Analyzer CS
	...
	// static	bool	IsSafeServerConnectEnabled()		{return m_bSafeServerConnect;}	// Tux: Newbie security: remove SafeServerConnect
	// static	void	SetSafeServerConnectEnabled(bool in){m_bSafeServerConnect=in;}	// Tux: Newbie security: remove SafeServerConnect
	...
	// Tux: LiteMule: Win7 addons always enabled [start]
/*
...
*/
	// Tux: LiteMule: Win7 addons always enabled [end]
	...
	//static	bool	UseSimpleTimeRemainingComputation()	{return m_bUseOldTimeRemaining;}	// Tux: LiteMule: Remove advanced calculation method checkbox
	...
	static	bool	GetLogSUQWT()						{return m_bVerbose && m_bLogSUQWT;}	// Tux: Feature: SUQWT
	static	bool	GetLogKadSecurityEvents()			{return m_bVerbose && m_bLogKadSecurityEvents;}	// Tux: Improvement: log Kad security events: changed line
	static	bool	GetLogAICHEvents()					{return m_bVerbose && m_bLogAICHEvents;}	// Tux: Improvement: log AICH events
	static	bool	GetLogSLSEvents()					{return m_bVerbose && m_bLogSLSEvents;}		// Tux: Improvement: log SLS events
	static	bool	GetLogCryptEvents()					{return m_bVerbose && m_bLogCryptEvents;}	// Tux: Improvement: log CryptLayer events
	// Tux: Feature: Client Analyzer [start]
	static	bool	GetLogAnalyzerEvents()				{return m_bVerbose && m_bLogAnalyzerEvents;}
	static	void	SetLogAnalyzerEvents(const bool& b)	{m_bLogAnalyzerEvents = b;}
...
// extern bool g_bLowColorDesktop; // Tux: LiteMule: no more low-color support: don't need that anymore
