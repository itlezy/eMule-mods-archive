...
#include "SearchListCtrl.h"	// Tux: Feature: Modeless dialogs
#include "opcodes.h"
#include "Packets.h"
	...
	: CAbstractFile(copyfrom)
{
	...
	m_searchDetailSheetInterface = new CSearchResultFileDetailSheetInterface(this);	// Tux: Feature: Modeless dialogs
}
...
{
	delete m_searchDetailSheetInterface;	// Tux: Feature: Modeless dialogs
