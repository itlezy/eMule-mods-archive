...
class CFileDataIO;
class CxImage;
class CSearchResultFileDetailSheetInterface;	// Tux: Feature: Modeless dialogs
...
public:
	...
	CSearchResultFileDetailSheetInterface*	GetSearchDetailSheetInterface() const { return m_searchDetailSheetInterface; }	// Tux: Feature: Modeless dialogs
...
private:
	...
	EKnownType	m_eKnown;
	CSearchResultFileDetailSheetInterface*	m_searchDetailSheetInterface;	// Tux: Feature: Modeless dialogs
};
