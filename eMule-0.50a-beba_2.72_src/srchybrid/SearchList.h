...
public:
	...
	void	Clear();
	void	NewSearch(CSearchListCtrl* in_wnd, CStringA strResultFileType, uint32 nSearchID, ESearchType eType, CString strSearchExpression);	// Tux: LiteMule: Remove MobileMule
