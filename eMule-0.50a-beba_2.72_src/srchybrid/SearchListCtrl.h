...
public:
	...
	void	SetStyle();	// Tux: Fix: Double-click behavior fix [WiZaRd]
...
class CSearchResultFileDetailSheetInterface : public CModelessPropertySheetInterface
{
public:
	CSearchResultFileDetailSheetInterface(CSearchFile* owner);
	void	OpenDetailSheet(CTypedPtrList<CPtrList, CSearchFile*>& aFiles, UINT uPshInvokePage = 0, CListCtrlItemWalk* pListCtrl = NULL);
