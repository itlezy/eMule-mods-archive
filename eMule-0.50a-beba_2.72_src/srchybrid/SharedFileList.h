...
public:
	...
	bool	AddSingleSharedFile(const CString& rstrFilePath, bool bNoUpdate, int &iDoAsfuReset); // includes updating sharing preferences, calls CheckAndAddSingleSharedFile afterwards // Tux: Feature: Automatic shared files updater
...
public: // Tux: Feature: Automatic shared files updater
	CStringList			m_liSingleSharedFiles;
private: // Tux: Feature: Automatic shared files updater
