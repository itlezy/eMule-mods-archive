...
{
public:
	CSharedFileDetailsSheetInterface(CShareableFile* owner);
	void	OpenDetailSheet(CTypedPtrList<CPtrList, CShareableFile*>& aFiles, UINT uPshInvokePage = 0, CListCtrlItemWalk* pListCtrl = NULL);
