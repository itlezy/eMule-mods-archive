...
#include "BtnST.h"	// Tux: Feature: Drop Buttons

class CDropDownButton;
class CButtonST;	// Tux: Feature: Drop Buttons
class CToolTipCtrlX;
...
protected:
	int decal;	// Tux: Feature: Drop Buttons

	CSplitterControl m_wndSplitter;
	EWnd2		m_uWnd2;
	//bool		downloadlistactive;	// Tux: Fix: removed hover tracking [SLUGFILLER]
	...
	DECLARE_MESSAGE_MAP()
	// afx_msg BOOL OnHelpInfo(HELPINFO* pHelpInfo);	// Tux: LiteMule: Remove Help
...
private:
	CButtonST	m_DropAllFullQBtn;
	CButtonST	m_DropAllNNSBtn;
	CButtonST	m_DropTooManyBtn;
	CButtonST	m_DropUnknownBtn;
