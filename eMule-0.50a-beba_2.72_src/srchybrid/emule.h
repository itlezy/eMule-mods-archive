...
#define	DEFAULT_NICK		L"beba.eMuleFuture.de"	// Tux: Improvement: changed default nick
...
class CAntiLeechDataList;	// Tux: Feature: Client Analyzer
...
public:
	...
	CAntiLeechDataList*	antileechlist;	// Tux: Feature: Client Analyzer
