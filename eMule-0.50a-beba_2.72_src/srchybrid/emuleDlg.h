...
#include "MeterIcon.h"
#include "TitleMenu.h"
#include "SnarlInterface.h" // Tux: Feature: Snarl notifications
...
public:
	...
	void RemoveUPnPMappings(); // Tux: Improvement: UPnP removal [WiZaRd]
	...
	Snarl::V42::SnarlInterface* snarlIface;
	void RegisterSnarl();
	bool hasSnarl;
