...
#define SHAREAZAEMUVERSION				0x3D	// Tux: Feature: Emulate Shareaza
...
#define	SPREADREASKTIME			MIN2MS(2)	//2 mins	// Tux: Feature: spreadReask
...
#define ET_L2HAC				0x3E	// Tux: Feature: L2HAC
