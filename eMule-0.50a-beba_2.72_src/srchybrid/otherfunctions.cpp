...
CString StringLimit(CString in, UINT length)
{
	if ((UINT)in.GetLength() <= length || length < 10)
		return in;
	// Tux: Fix: Fix for something [Avi3k] [start]
	// return (in.Left(length-8) + _T("...") + in.Right(8));
	return (in.Left(length-8) + _T("...") + in.Right(5));
	// Tux: Fix: Fix for something [Avi3k] [end]
}
...
} g_aED2KFileTypes[] = 
{
    ...
    { _T(".alac"),  ED2KFT_AUDIO },     // Apple Lossless Audio Codec File // Tux: Improvement: added more file types
    ...
    { _T(".opus"),  ED2KFT_AUDIO },     // Opus Audio File // Tux: Improvement: added more file types
    ...
    { _T(".shn"),   ED2KFT_AUDIO },     // Tux: Improvement: added more file types
    { _T(".snd"),   ED2KFT_AUDIO },     // Audio File (Sun, Unix)
    { _T(".stm"),   ED2KFT_AUDIO },     // Scream Tracker 2 Module
    { _T(".tak"),   ED2KFT_AUDIO },     // Tom's Audio-Kompressor File // Tux: Improvement: added more file types
    { _T(".umx"),   ED2KFT_AUDIO },     // Unreal Music Package
    { _T(".w64"),   ED2KFT_AUDIO },     // Tux: Improvement: added more file types
    { _T(".wav"),   ED2KFT_AUDIO },     // WAVE Audio File
    { _T(".wma"),   ED2KFT_AUDIO },     // Windows Media Audio File
    { _T(".wv"),    ED2KFT_AUDIO },     // WavPack Audio File // Tux: Improvement: added more file types
	...
	{ _T(".ogv"),   ED2KFT_VIDEO },     // Ogg Theora Video File // Tux: Improvement: added more file types
	...
	{ _T(".jp2"),   ED2KFT_IMAGE },     // JPEG2000 Image File // Tux: Improvement: added more file types
	...
	{ _T(".pspimage"), ED2KFT_IMAGE },  // Paint Shop Pro Image File // Tux: Improvement: added more file types
	...
	{ _T(".xbm"),   ED2KFT_IMAGE },     // X-Bitmap File // Tux: Improvement: added more file types
    { _T(".xif"),   ED2KFT_IMAGE },     // ScanSoft Pagis Extended Image Format File
	{ _T(".xpm"),   ED2KFT_IMAGE },     // X-Pixmap File // Tux: Improvement: added more file types
	...
	{ _T(".jar"),   ED2KFT_ARCHIVE },   // Java Archive // Tux: Improvement: added more file types
	...
	{ _T(".sqx"),   ED2KFT_ARCHIVE },   // Squeez Archive // Tux: Improvement: added more file types
    ...
    { _T(".uha"),   ED2KFT_ARCHIVE },   // uharc Archive // Tux: Improvement: added more file types
    { _T(".xpi"),   ED2KFT_ARCHIVE },   // Mozilla Installer Package
    { _T(".z"),     ED2KFT_ARCHIVE },   // Unix Compressed File
    { _T(".zip"),   ED2KFT_ARCHIVE },   // Zipped File
    { _T(".zipx"),  ED2KFT_ARCHIVE },   // Zipped File // Tux: Improvement: added more file types

	{ _T(".apk"),   ED2KFT_PROGRAM },   // Android package // Tux: Improvement: added more file types
	{ _T(".app"),   ED2KFT_PROGRAM },   // WindowMaker application // Tux: Improvement: added more file types
	...
	{ _T(".docx"),  ED2KFT_DOCUMENT },  // Document File // Tux: Improvement: added more file types
	{ _T(".dot"),   ED2KFT_DOCUMENT },  // Document Template File
	{ _T(".dotx"),  ED2KFT_DOCUMENT },  // Document Template File // Tux: Improvement: added more file types
	...
	{ _T(".odb"),   ED2KFT_DOCUMENT },  // OpenDocument File // Tux: Improvement: added more file types
	{ _T(".odf"),   ED2KFT_DOCUMENT },  // OpenDocument File // Tux: Improvement: added more file types
	{ _T(".odp"),   ED2KFT_DOCUMENT },  // OpenDocument File // Tux: Improvement: added more file types
	{ _T(".ods"),   ED2KFT_DOCUMENT },  // OpenDocument File // Tux: Improvement: added more file types
	{ _T(".odt"),   ED2KFT_DOCUMENT },  // OpenDocument File // Tux: Improvement: added more file types
    { _T(".pdf"),   ED2KFT_DOCUMENT },  // Portable Document Format File
    { _T(".pmd"),   ED2KFT_DOCUMENT },  // PageMaker Publication // Tux: Improvement: added more file types
    { _T(".pmv"),   ED2KFT_DOCUMENT },  // PlanMaker Spreadsheet // Tux: Improvement: added more file types
    { _T(".pps"),   ED2KFT_DOCUMENT },  // PowerPoint Slide Show
    { _T(".ppt"),   ED2KFT_DOCUMENT },  // PowerPoint Presentation
	{ _T(".pptx"),  ED2KFT_DOCUMENT },  // PowerPoint Presentation // Tux: Improvement: added more file types
    { _T(".ps"),    ED2KFT_DOCUMENT },  // PostScript File
    { _T(".qpw"),   ED2KFT_DOCUMENT },  // Quattro Pro Spreadsheet // Tux: Improvement: added more file types
    { _T(".rtf"),   ED2KFT_DOCUMENT },  // Rich Text Format File
    { _T(".text"),  ED2KFT_DOCUMENT },  // General Text File
    { _T(".tmd"),   ED2KFT_DOCUMENT },  // TextMaker Document // Tux: Improvement: added more file types
    { _T(".txt"),   ED2KFT_DOCUMENT },  // Text File
    { _T(".wpd"),   ED2KFT_DOCUMENT },  // WordPerfect Document // Tux: Improvement: added more file types
    { _T(".wri"),   ED2KFT_DOCUMENT },  // Windows Write Document
    { _T(".xls"),   ED2KFT_DOCUMENT },  // Microsoft Excel Spreadsheet
	{ _T(".xlsx"),  ED2KFT_DOCUMENT },  // Tux: Improvement: added more file types
	{ _T(".xlt"),   ED2KFT_DOCUMENT },  // Tux: Improvement: added more file types
    { _T(".xltx"),  ED2KFT_DOCUMENT },  // Tux: Improvement: added more file types
