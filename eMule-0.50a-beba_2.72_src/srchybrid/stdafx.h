...
#ifndef _WIN32_IE
// Tux: others: version bump [start]
#define _WIN32_IE 0x0600		// 0x0600 == Internet Explorer 6.0 
//#define _WIN32_IE 0x0560		// 0x0560 == Internet Explorer 5.6 -> Comctl32.dll v5.8
// Tux: others: version bump [end]
#endif
...
// Tux: others: VS2010 warnings [start]
#if _MSC_VER > 1500
#pragma warning(disable:4127) // Bedingter Ausdruck ist konstant
#pragma warning(disable:4242) // 'Argument': Konvertierung von 'unsigned int' in 'unsigned char', möglicher Datenverlust
#pragma warning(disable:4986) // "_bstr_t::Detach": Die Ausnahmespezifikation stimmt nicht mit der vorherigen Deklaration überein.
#pragma warning(disable:4987) // Es wurde eine nicht standardmäßige Erweiterung verwendet: "throw (...)"
#endif
// Tux: others: VS2010 warnings [else]
...
//#define _USE_32BIT_TIME_T // Tux: others: VS2010 fix
#endif
