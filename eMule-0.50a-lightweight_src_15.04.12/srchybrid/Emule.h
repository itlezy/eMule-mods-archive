...
public:
	...
	*/
	...
	bool				m_bRestartApp; // X-Ray :: AutoRestartIfNecessary
...
//	CString		CreateED2kHostnameSourceLink(const CAbstractFile* f);
	...
	void		UpdateSentBytes(uint32 bytesToAdd, bool sentToPBF = false);// ==> Pay Back First
	int			GetFileTypeSystemImageIdx(LPCTSTR pszFilePath, INT_PTR iLength = -1);
