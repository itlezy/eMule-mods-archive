...
public:
	...
	void	Process();
	//void	RemoveSocket(CClientReqSocket* todel);//Enig123::code improvements
	void	AddSocket(CClientReqSocket* toadd);
	size_t	GetOpenSockets()		{return socket_list.GetCount();}
	void	KillAllSockets();
...
#ifdef _DEBUG	//Enig123::don't declare when no needed
...
private:
	bool	bListening;
	CAtlList<CClientReqSocket*> socket_list;
