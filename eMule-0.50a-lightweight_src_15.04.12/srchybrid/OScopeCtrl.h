...
{
public:
	COScopeCtrl(size_t NTrends = 1);
	virtual ~COScopeCtrl();
	
	virtual BOOL Create(DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID = NULL);
	
	void SetTrendRatio(size_t iTrend, unsigned int iRatio = 1);
	void SetLegendLabel(CString string, size_t iTrend);
	...
	void SetPlotColor(COLORREF color, size_t iTrend = 0);
	COLORREF GetPlotColor(size_t iTrend = 0);
