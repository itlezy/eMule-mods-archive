...
public:
	...
	Packet(Packet* tocopy);//Enig123::bugfix by Xanatos [cyrex2001] ==>
	virtual ~Packet();
...
public:
	char*	pBuffer;
protected: // netfinity: Rearranged for alignment reasons
	char*	completebuffer;
	char*	tempbuffer;
public:
	uint32	size;
...
public:
	...
	uint_ptr GetType() const			{ return m_uType; }
	uint_ptr GetNameID() const			{ return m_uName; }
	...
	const	LPCTSTR GetStr() const	{ ASSERT(IsStr());		return m_pstrVal; } // Avi-3k
