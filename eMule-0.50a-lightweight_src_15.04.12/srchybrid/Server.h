...
//<<< Spike2::Aux Ports support [lugdunummaster]
	...
	uint64	GetLastPingedTime() const				{return lastpingedtime;}// X: [64T] - [64BitTime]
	void	SetLastPingedTime(uint64 in_lastpingedtime)	{lastpingedtime = in_lastpingedtime;}// X: [64T] - [64BitTime]

	uint64	GetRealLastPingedTime() const					{return m_dwRealLastPingedTime;} // last pinged time without any random modificator// X: [64T] - [64BitTime]
	void	SetRealLastPingedTime(uint64 in_lastpingedtime)	{m_dwRealLastPingedTime = in_lastpingedtime;}// X: [64T] - [64BitTime]
	...
	void	SetFiltered(bool isFiltered)		{isfiltered = isFiltered;}// X: [CI] - [Code Improvement]
...
private:
	...
	uint64		lastpingedtime; //This is to decided when we retry the ping.// X: [64T] - [64BitTime]
	...
	uint32		ip;
	uint16		port;
	uint16		realport; //>>> Spike2::Aux Ports support [lugdunummaster]
	...
	uint64		m_dwRealLastPingedTime;// X: [64T] - [64BitTime]
	bool		isfiltered;// X: [CI] - [Code Improvement]
