...
public:
	...
	size_t	GetServerCount() const { return list.GetCount(); }
	CServer*	GetServerAt(size_t pos) const { return list.GetAt(list.FindIndex(pos)); }
	...
	size_t	GetPositionOfServer(const CServer* pServer) const;
	...
	// ZZ:UploadSpeedSense -->
    //bool        GiveServersForTraceRoute();//Xman
	// ZZ:UploadSpeedSense <--
