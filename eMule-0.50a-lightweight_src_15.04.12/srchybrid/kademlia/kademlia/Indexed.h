...
namespace Kademlia
{
	...
	{
		public:
			class CLoadDataThread : public Poco::Thread
			{
			public:
				CLoadDataThread(CIndexed* pOwner);
				virtual void run();
			...
			bool AddLoad(const CUInt128& uKeyID, uint64 uTime, bool bIgnoreThreadLock = false);// X: [64T] - [64BitTime]
			uint_ptr GetFileKeyCount();
			...
			uint_ptr m_uTotalIndexSource;
			uint_ptr m_uTotalIndexKeyword;
			//uint_ptr m_uTotalIndexNotes;
			uint_ptr m_uTotalIndexLoad;
