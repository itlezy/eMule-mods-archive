...
namespace Kademlia
{
	...
	class CKademliaUDPListener : public CPacketTracking
	{
		...
		public:
			...
			void SendPacket(const byte* pbyData, uint_ptr uLenData, uint32 uDestinationHost, uint16 uDestinationPort, CKadUDPKey targetUDPKey, const CUInt128* uCryptTargetID);
			void SendPacket(const byte *pbyData, uint_ptr uLenData, byte byOpcode, uint32 uDestinationHost, uint16 uDestinationPort, CKadUDPKey targetUDPKey, const CUInt128* uCryptTargetID);
		...
		private:
			...
			CAtlList<FetchNodeID_Struct> listFetchNodeIDRequests;
