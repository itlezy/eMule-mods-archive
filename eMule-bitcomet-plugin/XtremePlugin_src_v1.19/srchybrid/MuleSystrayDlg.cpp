...
BOOL CMuleSystrayDlg::OnInitDialog() 
{
	...
	CWnd *p;
	/* Xman
	m_hUpArrow = theAppPtr->LoadIcon(_T("UPLOAD"));
	m_hDownArrow = theAppPtr->LoadIcon(_T("DOWNLOAD"));
    ...
    */	
	...
	if(p)
	{
		...
		m_ctrlSpeed.m_hIcon = theAppPtr->LoadIcon(_T("SPEED"), m_ctrlSpeed.m_sIcon.cx, m_ctrlSpeed.m_sIcon.cy);
	...
	if(p)
	{
		...
		m_ctrlAllToMax.m_hIcon = theAppPtr->LoadIcon(_T("SPEEDMAX"), m_ctrlAllToMax.m_sIcon.cx, m_ctrlAllToMax.m_sIcon.cy);
	...
	if(p)
	{
		...
		m_ctrlAllToMin.m_hIcon = theAppPtr->LoadIcon(_T("SPEEDMIN"), m_ctrlAllToMin.m_sIcon.cx, m_ctrlAllToMin.m_sIcon.cy);
	...
	*/
	...
	if(p)
	{
		...
		m_ctrlRestore.m_hIcon = theAppPtr->LoadIcon(_T("RESTOREWINDOW"), m_ctrlRestore.m_sIcon.cx, m_ctrlRestore.m_sIcon.cy);
	...
	if(p)
	{
		...
		m_ctrlConnect.m_hIcon = theAppPtr->LoadIcon(_T("CONNECT"), m_ctrlConnect.m_sIcon.cx, m_ctrlConnect.m_sIcon.cy);
	...
	if(p)
	{
		...
		m_ctrlDisconnect.m_hIcon = theAppPtr->LoadIcon(_T("DISCONNECT"), m_ctrlDisconnect.m_sIcon.cx, m_ctrlDisconnect.m_sIcon.cy);
	...
	if(p)
	{
		...
		m_ctrlPreferences.m_hIcon = theAppPtr->LoadIcon(_T("Preferences"), m_ctrlPreferences.m_sIcon.cx, m_ctrlPreferences.m_sIcon.cy);
	...
	if(p)
	{
		...
		m_ctrlExit.m_hIcon = theAppPtr->LoadIcon(_T("EXIT"), m_ctrlExit.m_sIcon.cx, m_ctrlExit.m_sIcon.cy);
	...
	*/ //Xman
	...
	m_ctrlSidebar.SetWindowText(_T("eMule ") + theAppPtr->m_strCurVersionLong);
