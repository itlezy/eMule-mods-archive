...
void CPerfLog::LogSamples()
{
	...
	*/
	UINT nCurDn = (UINT)(theAppPtr->pBandWidthControl->GeteMuleIn() - m_nLastSessionRecvBytes);
	UINT nCurUp = (UINT)(theAppPtr->pBandWidthControl->GeteMuleOut() - m_nLastSessionSentBytes);
	UINT nCurDnOH = (UINT)(theAppPtr->pBandWidthControl->GeteMuleInOverall() - m_nLastDnOH);
	UINT nCurUpOH = (UINT)(theAppPtr->pBandWidthControl->GeteMuleOutOverall() - m_nLastUpOH);

	WriteSamples(nCurDn, nCurUp, nCurDnOH, nCurUpOH);

	m_nLastSessionRecvBytes = theAppPtr->pBandWidthControl->GeteMuleIn();
	m_nLastSessionSentBytes = theAppPtr->pBandWidthControl->GeteMuleOut();
	m_nLastDnOH = theAppPtr->pBandWidthControl->GeteMuleInOverall();
	m_nLastUpOH = theAppPtr->pBandWidthControl->GeteMuleOutOverall();
	//Xman end
