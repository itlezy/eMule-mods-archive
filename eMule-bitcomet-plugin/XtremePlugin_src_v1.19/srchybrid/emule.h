...
public:
	...
	CemuleApp(CCore_eMuleApp* pDllApp, LPCTSTR lpszAppName = NULL);
	~CemuleApp();
...
public:
	CCore_eMuleApp* m_pDllApp;
};

//extern CemuleApp theApp;
extern CemuleApp* theAppPtr;
