...
//Xman changed to 50
//set his lower if you want less connections at once, set it higher if you have enough sockets (edonkey has its own timout too, so a very high value won't effect this)
/*
#define CONNECTION_TIMEOUT		SEC2MS(40)	
*/
#define CONNECTION_TIMEOUT		SEC2MS(50)	
//Xman end
