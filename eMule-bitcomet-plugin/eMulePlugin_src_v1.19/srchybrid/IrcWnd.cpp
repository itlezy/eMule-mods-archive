...
BOOL CIrcWnd::OnInitDialog()
{
	...
	UpdateFonts(&theAppPtr->m_fontHyperText);
	...
	{
		m_wndInput.SendMessage(WM_SETFONT, (WPARAM)theAppPtr->m_fontChatEdit.m_hObject, FALSE);
		CRect rcEdit;
...
{
	theAppPtr->ShowHelp(eMule_FAQ_GUI_IRC);
	return TRUE;
}
